defmodule Jirex.Avatars do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_avatar(type, owningObjectId, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Avatars, :delete_avatar},
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_all_system_avatars(String.t(), keyword) :: {:ok, Jirex.SystemAvatars.t()} | :error
  def get_all_system_avatars(type, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [type: type],
      call: {Jirex.Avatars, :get_all_system_avatars},
      url: "/rest/api/2/avatar/#{type}/system",
      method: :get,
      response: [{200, {Jirex.SystemAvatars, :t}}, {401, :null}, {500, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  @spec get_avatar_image_by_id(String.t(), integer, keyword) ::
          {:ok, any | Jirex.StreamingResponseBody.t()} | {:error, any | Jirex.ErrorCollection.t()}
  def get_avatar_image_by_id(type, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Avatars, :get_avatar_image_by_id},
      url: "/rest/api/2/universal_avatar/view/type/#{type}/avatar/#{id}",
      method: :get,
      query: query,
      response: [
        {200, {:union, [:unknown, {Jirex.StreamingResponseBody, :t}]}},
        {400, {:union, [:unknown, {Jirex.ErrorCollection, :t}]}},
        {401, {:union, [:unknown, {Jirex.ErrorCollection, :t}]}},
        {403, {:union, [:unknown, {Jirex.ErrorCollection, :t}]}},
        {404, {:union, [:unknown, {Jirex.ErrorCollection, :t}]}}
      ],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_avatar_image_by_owner(type, entityId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Avatars, :get_avatar_image_by_owner},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def get_avatar_image_by_type(type, opts \\ []) do
    ...
    client.request(%{
      args: [type: type],
      call: {Jirex.Avatars, :get_avatar_image_by_type},
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_avatars(type, entityId, opts \\ []) do
    ...
    client.request(%{
      args: [type: type, entityId: entityId],
      call: {Jirex.Avatars, :get_avatars},
      url: "/rest/api/2/universal_avatar/type/#{type}/owner/#{entityId}",
      method: :get,
      response: [{200, {Jirex.Avatars, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec store_avatar(String.t(), String.t(), map, keyword) :: {:ok, Jirex.Avatar.t()} | :error
  def store_avatar(type, entityId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Avatars, :store_avatar},
      url: "/rest/api/2/universal_avatar/type/#{type}/owner/#{entityId}",
      body: body,
      method: :post,
      query: query,
  ...
  @type t :: %__MODULE__{custom: [Jirex.Avatar.t()] | nil, system: [Jirex.Avatar.t()] | nil}
  ...
  def __fields__(:t) do
    [custom: [{Jirex.Avatar, :t}], system: [{Jirex.Avatar, :t}]]
  end
end
