defmodule Jirex.Dashboards do
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec add_gadget(integer, Jirex.DashboardGadgetSettings.t(), keyword) ::
          {:ok, Jirex.DashboardGadget.t()} | {:error, Jirex.ErrorCollection.t()}
  def add_gadget(dashboardId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [dashboardId: dashboardId, body: body],
      call: {Jirex.Dashboards, :add_gadget},
      url: "/rest/api/2/dashboard/#{dashboardId}/gadget",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.DashboardGadgetSettings, :t}}],
      response: [
        {200, {Jirex.DashboardGadget, :t}},
  ...
  **[Permissions](#permissions) required:** None
  ...
  """
  @spec bulk_edit_dashboards(Jirex.BulkEditShareableEntityRequest.t(), keyword) ::
          {:ok, Jirex.BulkEditShareableEntityResponse.t()} | {:error, Jirex.ErrorCollection.t()}
  def bulk_edit_dashboards(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Dashboards, :bulk_edit_dashboards},
      url: "/rest/api/2/dashboard/bulk/edit",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.BulkEditShareableEntityRequest, :t}}],
      response: [
        {200, {Jirex.BulkEditShareableEntityResponse, :t}},
        {400, {Jirex.ErrorCollection, :t}},
  ...
  **[Permissions](#permissions) required:** None
  ...
  """
  @spec copy_dashboard(String.t(), Jirex.DashboardDetails.t(), keyword) ::
          {:ok, Jirex.Dashboard.t()} | {:error, Jirex.ErrorCollection.t()}
  def copy_dashboard(id, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.Dashboards, :copy_dashboard},
      url: "/rest/api/2/dashboard/#{id}/copy",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.DashboardDetails, :t}}],
      response: [
        {200, {Jirex.Dashboard, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
        {404, {Jirex.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec create_dashboard(Jirex.DashboardDetails.t(), keyword) ::
          {:ok, Jirex.Dashboard.t()} | {:error, Jirex.ErrorCollection.t()}
  def create_dashboard(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.Dashboards, :create_dashboard},
  ...
  **[Permissions](#permissions) required:** None
  ...
  """
  @spec delete_dashboard(String.t(), keyword) :: :ok | {:error, Jirex.ErrorCollection.t()}
  def delete_dashboard(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.Dashboards, :delete_dashboard},
  ...
  **[Permissions](#permissions) required:** The user must be the owner of the dashboard. Note, users with the *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) are considered owners of the System dashboard.
  ...
  def delete_dashboard_item_property(dashboardId, itemId, propertyKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Dashboards, :delete_dashboard_item_property},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_all_available_dashboard_gadgets(keyword) ::
          {:ok, Jirex.AvailableDashboardGadgetsResponse.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_all_available_dashboard_gadgets(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jirex.Dashboards, :get_all_available_dashboard_gadgets},
      url: "/rest/api/2/dashboard/gadgets",
      method: :get,
      response: [
        {200, {Jirex.AvailableDashboardGadgetsResponse, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_all_dashboards(keyword) ::
          {:ok, Jirex.PageOfDashboards.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_all_dashboards(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.Dashboards, :get_all_dashboards},
      url: "/rest/api/2/dashboard",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageOfDashboards, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_all_gadgets(integer, keyword) ::
          {:ok, Jirex.DashboardGadgetResponse.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_all_gadgets(dashboardId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Dashboards, :get_all_gadgets},
      url: "/rest/api/2/dashboard/#{dashboardId}/gadget",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.DashboardGadgetResponse, :t}},
        {401, :null},
        {404, {Jirex.ErrorCollection, :t}}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def get_dashboard(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.Dashboards, :get_dashboard},
      url: "/rest/api/2/dashboard/#{id}",
      method: :get,
      response: [
        {200, {Jirex.Dashboard, :t}},
  ...
  **[Permissions](#permissions) required:** The user must be the owner of the dashboard or have the dashboard shared with them. Note, users with the *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) are considered owners of the System dashboard. The System dashboard is considered to be shared with all other users, and is accessible to anonymous users when Jira\\u2019s anonymous access is permitted.
  ...
  @spec get_dashboard_item_property(String.t(), String.t(), String.t(), keyword) ::
          {:ok, Jirex.EntityProperty.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_dashboard_item_property(dashboardId, itemId, propertyKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [dashboardId: dashboardId, itemId: itemId, propertyKey: propertyKey],
      call: {Jirex.Dashboards, :get_dashboard_item_property},
      url: "/rest/api/2/dashboard/#{dashboardId}/items/#{itemId}/properties/#{propertyKey}",
      method: :get,
      response: [
  ...
  **[Permissions](#permissions) required:** The following dashboards that match the query parameters are returned:
  ...
  @spec get_dashboards_paginated(keyword) ::
          {:ok, Jirex.PageBeanDashboard.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_dashboards_paginated(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.Dashboards, :get_dashboards_paginated},
      url: "/rest/api/2/dashboard/search",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanDashboard, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def remove_gadget(dashboardId, gadgetId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Dashboards, :remove_gadget},
      url: "/rest/api/2/dashboard/#{dashboardId}/gadget/#{gadgetId}",
      method: :delete,
      response: [{204, :map}, {401, :null}, {404, {Jirex.ErrorCollection, :t}}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** The user must be the owner of the dashboard. Note, users with the *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) are considered owners of the System dashboard.
  ...
  def set_dashboard_item_property(dashboardId, itemId, propertyKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Dashboards, :set_dashboard_item_property},
      url: "/rest/api/2/dashboard/#{dashboardId}/items/#{itemId}/properties/#{propertyKey}",
      body: body,
      method: :put,
  ...
  **[Permissions](#permissions) required:** None
  ...
  """
  @spec update_dashboard(String.t(), Jirex.DashboardDetails.t(), keyword) ::
          {:ok, Jirex.Dashboard.t()} | {:error, Jirex.ErrorCollection.t()}
  def update_dashboard(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.Dashboards, :update_dashboard},
      url: "/rest/api/2/dashboard/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.DashboardDetails, :t}}],
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec update_gadget(integer, integer, Jirex.DashboardGadgetUpdateRequest.t(), keyword) ::
          {:ok, map} | {:error, Jirex.ErrorCollection.t()}
  def update_gadget(dashboardId, gadgetId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Dashboards, :update_gadget},
      url: "/rest/api/2/dashboard/#{dashboardId}/gadget/#{gadgetId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.DashboardGadgetUpdateRequest, :t}}],
      response: [
        {204, :map},
        {400, {Jirex.ErrorCollection, :t}},
        {401, :null},
