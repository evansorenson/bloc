defmodule Jirex.IssueLinks do
  ...
  **[Permissions](#permissions) required:**
  ...
  def delete_issue_link(linkId, opts \\ []) do
    ...
    client.request(%{
      args: [linkId: linkId],
      call: {Jirex.IssueLinks, :delete_issue_link},
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, permission to view both of the issues.
  """
  @spec get_issue_link(String.t(), keyword) :: {:ok, Jirex.IssueLink.t()} | :error
  def get_issue_link(linkId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [linkId: linkId],
      call: {Jirex.IssueLinks, :get_issue_link},
      url: "/rest/api/2/issueLink/#{linkId}",
      method: :get,
      response: [{200, {Jirex.IssueLink, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec link_issues(Jirex.LinkIssueRequestJsonBean.t(), keyword) :: {:ok, map} | :error
  def link_issues(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.IssueLinks, :link_issues},
      url: "/rest/api/2/issueLink",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.LinkIssueRequestJsonBean, :t}}],
      response: [{201, :map}, {400, :null}, {401, :null}, {404, :null}, {413, :null}],
      opts: opts
    })
  end
end
