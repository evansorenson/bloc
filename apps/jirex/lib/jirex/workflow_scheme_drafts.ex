defmodule Jirex.WorkflowSchemeDrafts do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def create_workflow_scheme_draft_from_parent(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :create_workflow_scheme_draft_from_parent},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_draft_default_workflow(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :delete_draft_default_workflow},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_draft_workflow_mapping(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :delete_draft_workflow_mapping},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_workflow_scheme_draft(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :delete_workflow_scheme_draft},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_workflow_scheme_draft_issue_type(id, issueType, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.WorkflowSchemeDrafts, :delete_workflow_scheme_draft_issue_type},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_draft_default_workflow(integer, keyword) :: {:ok, Jirex.DefaultWorkflow.t()} | :error
  def get_draft_default_workflow(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :get_draft_default_workflow},
      url: "/rest/api/2/workflowscheme/#{id}/draft/default",
      method: :get,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_draft_workflow(integer, keyword) ::
          {:ok, Jirex.IssueTypesWorkflowMapping.t()} | :error
  def get_draft_workflow(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :get_draft_workflow},
      url: "/rest/api/2/workflowscheme/#{id}/draft/workflow",
      method: :get,
      query: query,
      response: [
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_workflow_scheme_draft(integer, keyword) :: {:ok, Jirex.WorkflowScheme.t()} | :error
  def get_workflow_scheme_draft(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.WorkflowSchemeDrafts, :get_workflow_scheme_draft},
      url: "/rest/api/2/workflowscheme/#{id}/draft",
      method: :get,
      response: [{200, {Jirex.WorkflowScheme, :t}}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def get_workflow_scheme_draft_issue_type(id, issueType, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, issueType: issueType],
      call: {Jirex.WorkflowSchemeDrafts, :get_workflow_scheme_draft_issue_type},
      url: "/rest/api/2/workflowscheme/#{id}/draft/issuetype/#{issueType}",
      method: :get,
      response: [
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec publish_draft_workflow_scheme(integer, Jirex.PublishDraftWorkflowScheme.t(), keyword) ::
          :ok | {:error, any}
  def publish_draft_workflow_scheme(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.WorkflowSchemeDrafts, :publish_draft_workflow_scheme},
      url: "/rest/api/2/workflowscheme/#{id}/draft/publish",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jirex.PublishDraftWorkflowScheme, :t}}],
      response: [
        {204, :null},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def set_workflow_scheme_draft_issue_type(id, issueType, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.WorkflowSchemeDrafts, :set_workflow_scheme_draft_issue_type},
      url: "/rest/api/2/workflowscheme/#{id}/draft/issuetype/#{issueType}",
      body: body,
      method: :put,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_draft_default_workflow(integer, Jirex.DefaultWorkflow.t(), keyword) ::
          {:ok, Jirex.WorkflowScheme.t()} | :error
  def update_draft_default_workflow(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.WorkflowSchemeDrafts, :update_draft_default_workflow},
      url: "/rest/api/2/workflowscheme/#{id}/draft/default",
      body: body,
      method: :put,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec update_draft_workflow_mapping(integer, Jirex.IssueTypesWorkflowMapping.t(), keyword) ::
          {:ok, Jirex.WorkflowScheme.t()} | :error
  def update_draft_workflow_mapping(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.WorkflowSchemeDrafts, :update_draft_workflow_mapping},
      url: "/rest/api/2/workflowscheme/#{id}/draft/workflow",
      body: body,
      method: :put,
      query: query,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_workflow_scheme_draft(integer, Jirex.WorkflowScheme.t(), keyword) ::
          {:ok, Jirex.WorkflowScheme.t()} | :error
  def update_workflow_scheme_draft(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.WorkflowSchemeDrafts, :update_workflow_scheme_draft},
      url: "/rest/api/2/workflowscheme/#{id}/draft",
      body: body,
      method: :put,
