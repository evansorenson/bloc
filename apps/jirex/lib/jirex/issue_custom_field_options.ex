defmodule Jirex.IssueCustomFieldOptions do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec create_custom_field_option(
          String.t(),
          integer,
          Jirex.BulkCustomFieldOptionCreateRequest.t(),
          keyword
        ) :: {:ok, Jirex.CustomFieldCreatedContextOptionsList.t()} | {:error, any}
  def create_custom_field_option(fieldId, contextId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jirex.IssueCustomFieldOptions, :create_custom_field_option},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}/option",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.BulkCustomFieldOptionCreateRequest, :t}}],
      response: [
        {200, {Jirex.CustomFieldCreatedContextOptionsList, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_custom_field_option(fieldId, contextId, optionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptions, :delete_custom_field_option},
  ...
  **[Permissions](#permissions) required:** The custom field option is returned as follows:
  ...
  @spec get_custom_field_option(String.t(), keyword) ::
          {:ok, Jirex.CustomFieldOption.t()} | :error
  def get_custom_field_option(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.IssueCustomFieldOptions, :get_custom_field_option},
      url: "/rest/api/2/customFieldOption/#{id}",
      method: :get,
      response: [{200, {Jirex.CustomFieldOption, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_options_for_context(String.t(), integer, keyword) ::
          {:ok, Jirex.PageBeanCustomFieldContextOption.t()} | {:error, any}
  def get_options_for_context(fieldId, contextId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptions, :get_options_for_context},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}/option",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanCustomFieldContextOption, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec reorder_custom_field_options(
          String.t(),
          integer,
          Jirex.OrderOfCustomFieldOptions.t(),
          keyword
        ) :: {:ok, map} | {:error, any}
  def reorder_custom_field_options(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jirex.IssueCustomFieldOptions, :reorder_custom_field_options},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}/option/move",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.OrderOfCustomFieldOptions, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def replace_custom_field_option(fieldId, optionId, contextId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptions, :replace_custom_field_option},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec update_custom_field_option(
          String.t(),
          integer,
          Jirex.BulkCustomFieldOptionUpdateRequest.t(),
          keyword
        ) :: {:ok, Jirex.CustomFieldUpdatedContextOptionsList.t()} | {:error, any}
  def update_custom_field_option(fieldId, contextId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jirex.IssueCustomFieldOptions, :update_custom_field_option},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}/option",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.BulkCustomFieldOptionUpdateRequest, :t}}],
      response: [
        {200, {Jirex.CustomFieldUpdatedContextOptionsList, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
