defmodule Jirex.IssueWorklogs do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec add_worklog(String.t(), Jirex.Worklog.t(), keyword) :: {:ok, Jirex.Worklog.t()} | :error
  def add_worklog(issueIdOrKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueWorklogs, :add_worklog},
      url: "/rest/api/2/issue/#{issueIdOrKey}/worklog",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jirex.Worklog, :t}}],
      response: [
        {201, {Jirex.Worklog, :t}},
        {400, :null},
        {401, :null},
  ...
  **[Permissions](#permissions) required:**
  ...
  def delete_worklog(issueIdOrKey, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueWorklogs, :delete_worklog},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  """
  @spec get_ids_of_worklogs_deleted_since(keyword) :: {:ok, Jirex.ChangedWorklogs.t()} | :error
  def get_ids_of_worklogs_deleted_since(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueWorklogs, :get_ids_of_worklogs_deleted_since},
      url: "/rest/api/2/worklog/deleted",
      method: :get,
      query: query,
      response: [{200, {Jirex.ChangedWorklogs, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira, however, worklogs are only returned where either of the following is true:
  ...
  """
  @spec get_ids_of_worklogs_modified_since(keyword) :: {:ok, Jirex.ChangedWorklogs.t()} | :error
  def get_ids_of_worklogs_modified_since(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueWorklogs, :get_ids_of_worklogs_modified_since},
  ...
  **[Permissions](#permissions) required:** Workloads are only returned where the user has:
  ...
  """
  @spec get_issue_worklog(String.t(), keyword) :: {:ok, Jirex.PageOfWorklogs.t()} | :error
  def get_issue_worklog(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueWorklogs, :get_issue_worklog},
      url: "/rest/api/2/issue/#{issueIdOrKey}/worklog",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageOfWorklogs, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_worklog(String.t(), String.t(), keyword) :: {:ok, Jirex.Worklog.t()} | :error
  def get_worklog(issueIdOrKey, id, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey, id: id],
      call: {Jirex.IssueWorklogs, :get_worklog},
      url: "/rest/api/2/issue/#{issueIdOrKey}/worklog/#{id}",
      method: :get,
      query: query,
      response: [{200, {Jirex.Worklog, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira, however, worklogs are only returned where either of the following is true:
  ...
  """
  @spec get_worklogs_for_ids(Jirex.WorklogIdsRequestBean.t(), keyword) ::
          {:ok, [Jirex.Worklog.t()]} | :error
  def get_worklogs_for_ids(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.IssueWorklogs, :get_worklogs_for_ids},
      url: "/rest/api/2/worklog/list",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jirex.WorklogIdsRequestBean, :t}}],
      response: [{200, [{Jirex.Worklog, :t}]}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec update_worklog(String.t(), String.t(), Jirex.Worklog.t(), keyword) ::
          {:ok, Jirex.Worklog.t()} | :error
  def update_worklog(issueIdOrKey, id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueWorklogs, :update_worklog},
      url: "/rest/api/2/issue/#{issueIdOrKey}/worklog/#{id}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", {Jirex.Worklog, :t}}],
      response: [{200, {Jirex.Worklog, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
end
