defmodule Jirex.Projects do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def archive_project(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Projects, :archive_project},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_project(Jirex.CreateProjectDetails.t(), keyword) ::
          {:ok, Jirex.ProjectIdentifiers.t()} | :error
  def create_project(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Projects, :create_project},
      url: "/rest/api/2/project",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.CreateProjectDetails, :t}}],
      response: [{201, {Jirex.ProjectIdentifiers, :t}}, {400, :null}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_project(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.Projects, :delete_project},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_project_asynchronously(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.Projects, :delete_project_asynchronously},
  ...
  **[Permissions](#permissions) required:** Projects are returned only where the user has *Browse Projects* or *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  """
  @spec get_all_projects(keyword) :: {:ok, [Jirex.Project.t()]} | :error
  def get_all_projects(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.Projects, :get_all_projects},
      url: "/rest/api/2/project",
      method: :get,
      query: query,
      response: [{200, [{Jirex.Project, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  """
  @spec get_all_statuses(String.t(), keyword) :: {:ok, [Jirex.IssueTypeWithStatus.t()]} | :error
  def get_all_statuses(projectIdOrKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.Projects, :get_all_statuses},
      url: "/rest/api/2/project/#{projectIdOrKey}/statuses",
      method: :get,
      response: [{200, [{Jirex.IssueTypeWithStatus, :t}]}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  """
  @spec get_hierarchy(integer, keyword) :: {:ok, Jirex.ProjectIssueTypeHierarchy.t()} | :error
  def get_hierarchy(projectId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [projectId: projectId],
      call: {Jirex.Projects, :get_hierarchy},
      url: "/rest/api/2/project/#{projectId}/hierarchy",
      method: :get,
      response: [
        {200, {Jirex.ProjectIssueTypeHierarchy, :t}},
        {400, :null},
        {401, :null},
        {404, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) or *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg).
  ...
  @spec get_notification_scheme_for_project(String.t(), keyword) ::
          {:ok, Jirex.NotificationScheme.t()} | :error
  def get_notification_scheme_for_project(projectKeyOrId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Projects, :get_notification_scheme_for_project},
  ...
  **[Permissions](#permissions) required:** *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  """
  @spec get_project(String.t(), keyword) :: {:ok, Jirex.Project.t()} | :error
  def get_project(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.Projects, :get_project},
      url: "/rest/api/2/project/#{projectIdOrKey}",
      method: :get,
      query: query,
      response: [{200, {Jirex.Project, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Projects are returned only where the user has one of:
  ...
  """
  @spec get_recent(keyword) :: {:ok, [Jirex.Project.t()]} | :error
  def get_recent(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.Projects, :get_recent},
      url: "/rest/api/2/project/recent",
      method: :get,
      query: query,
      response: [{200, [{Jirex.Project, :t}]}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec restore(String.t(), keyword) :: {:ok, Jirex.Project.t()} | :error
  def restore(projectIdOrKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.Projects, :restore},
      url: "/rest/api/2/project/#{projectIdOrKey}/restore",
      method: :post,
      response: [{200, {Jirex.Project, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Projects are returned only where the user has one of:
  ...
  """
  @spec search_projects(keyword) :: {:ok, Jirex.PageBeanProject.t()} | :error
  def search_projects(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.Projects, :search_projects},
      url: "/rest/api/2/project/search",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBeanProject, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). is only needed when changing the schemes or project key. Otherwise you will only need *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg)
  ...
  """
  @spec update_project(String.t(), Jirex.UpdateProjectDetails.t(), keyword) ::
          {:ok, Jirex.Project.t()} | :error
  def update_project(projectIdOrKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.Projects, :update_project},
      url: "/rest/api/2/project/#{projectIdOrKey}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", {Jirex.UpdateProjectDetails, :t}}],
      response: [
        {200, {Jirex.Project, :t}},
        {400, :null},
        {401, :null},
