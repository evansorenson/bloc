defmodule Jirex.ProjectComponents do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project in which the component is created or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_component(Jirex.ProjectComponent.t(), keyword) ::
          {:ok, Jirex.ProjectComponent.t()} | :error
  def create_component(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.ProjectComponents, :create_component},
      url: "/rest/api/2/component",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.ProjectComponent, :t}}],
      response: [
        {201, {Jirex.ProjectComponent, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null}
  ...
  **[Permissions](#permissions) required:** *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project containing the component or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_component(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectComponents, :delete_component},
  ...
  **[Permissions](#permissions) required:** *Browse Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  @spec find_components_for_projects(keyword) ::
          {:ok, Jirex.PageBean2ComponentJsonBean.t()} | :error
  def find_components_for_projects(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.ProjectComponents, :find_components_for_projects},
      url: "/rest/api/2/component",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBean2ComponentJsonBean, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for project containing the component.
  """
  @spec get_component(String.t(), keyword) :: {:ok, Jirex.ProjectComponent.t()} | :error
  def get_component(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectComponents, :get_component},
      url: "/rest/api/2/component/#{id}",
      method: :get,
      response: [{200, {Jirex.ProjectComponent, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_component_related_issues(String.t(), keyword) ::
          {:ok, Jirex.ComponentIssuesCount.t()} | :error
  def get_component_related_issues(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectComponents, :get_component_related_issues},
      url: "/rest/api/2/component/#{id}/relatedIssueCounts",
      method: :get,
      response: [{200, {Jirex.ComponentIssuesCount, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  def get_project_components(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectComponents, :get_project_components},
  ...
  **[Permissions](#permissions) required:** *Browse Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  @spec get_project_components_paginated(String.t(), keyword) ::
          {:ok, Jirex.PageBeanComponentWithIssueCount.t()} | :error
  def get_project_components_paginated(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.ProjectComponents, :get_project_components_paginated},
      url: "/rest/api/2/project/#{projectIdOrKey}/component",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBeanComponentWithIssueCount, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project containing the component or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_component(String.t(), Jirex.ProjectComponent.t(), keyword) ::
          {:ok, Jirex.ProjectComponent.t()} | :error
  def update_component(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectComponents, :update_component},
      url: "/rest/api/2/component/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.ProjectComponent, :t}}],
      response: [
        {200, {Jirex.ProjectComponent, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null}
