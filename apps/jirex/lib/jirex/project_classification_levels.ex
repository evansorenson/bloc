defmodule Jirex.ProjectClassificationLevels do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_default_project_classification(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectClassificationLevels, :get_default_project_classification},
  ...
  **[Permissions](#permissions) required:**
  ...
  def remove_default_project_classification(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.ProjectClassificationLevels, :remove_default_project_classification},
      url: "/rest/api/2/project/#{projectIdOrKey}/classification-level/default",
      method: :delete,
  ...
  **[Permissions](#permissions) required:**
  ...
  @spec update_default_project_classification(
          String.t(),
          Jirex.UpdateDefaultProjectClassificationBean.t(),
          keyword
        ) :: {:ok, map} | :error
  def update_default_project_classification(projectIdOrKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectClassificationLevels, :update_default_project_classification},
      url: "/rest/api/2/project/#{projectIdOrKey}/classification-level/default",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.UpdateDefaultProjectClassificationBean, :t}}],
      response: [{204, :map}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
