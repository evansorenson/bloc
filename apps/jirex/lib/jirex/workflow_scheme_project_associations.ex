defmodule Jirex.WorkflowSchemeProjectAssociations do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec assign_scheme_to_project(Jirex.WorkflowSchemeProjectAssociation.t(), keyword) ::
          {:ok, map} | {:error, any}
  def assign_scheme_to_project(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.WorkflowSchemeProjectAssociations, :assign_scheme_to_project},
      url: "/rest/api/2/workflowscheme/project",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.WorkflowSchemeProjectAssociation, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_workflow_scheme_project_associations(keyword) ::
          {:ok, Jirex.ContainerOfWorkflowSchemeAssociations.t()} | {:error, any}
  def get_workflow_scheme_project_associations(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.WorkflowSchemeProjectAssociations, :get_workflow_scheme_project_associations},
      url: "/rest/api/2/workflowscheme/project",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.ContainerOfWorkflowSchemeAssociations, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown}
      ],
