defmodule Jirex.ProjectRoles do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_project_role(Jirex.CreateUpdateRoleRequestBean.t(), keyword) ::
          {:ok, Jirex.ProjectRole.t()} | :error
  def create_project_role(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.ProjectRoles, :create_project_role},
      url: "/rest/api/2/role",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.CreateUpdateRoleRequestBean, :t}}],
      response: [
        {200, {Jirex.ProjectRole, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {409, :null}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_project_role(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectRoles, :delete_project_role},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec fully_update_project_role(integer, Jirex.CreateUpdateRoleRequestBean.t(), keyword) ::
          {:ok, Jirex.ProjectRole.t()} | :error
  def fully_update_project_role(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoles, :fully_update_project_role},
      url: "/rest/api/2/role/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.CreateUpdateRoleRequestBean, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_all_project_roles(keyword) :: {:ok, [Jirex.ProjectRole.t()]} | :error
  def get_all_project_roles(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jirex.ProjectRoles, :get_all_project_roles},
      url: "/rest/api/2/role",
      method: :get,
      response: [{200, [{Jirex.ProjectRole, :t}]}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_project_role(String.t(), integer, keyword) :: {:ok, Jirex.ProjectRole.t()} | :error
  def get_project_role(projectIdOrKey, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoles, :get_project_role},
      url: "/rest/api/2/project/#{projectIdOrKey}/role/#{id}",
      method: :get,
      query: query,
      response: [{200, {Jirex.ProjectRole, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_project_role_by_id(integer, keyword) :: {:ok, Jirex.ProjectRole.t()} | :error
  def get_project_role_by_id(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectRoles, :get_project_role_by_id},
      url: "/rest/api/2/role/#{id}",
      method: :get,
      response: [{200, {Jirex.ProjectRole, :t}}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) or *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
  ...
  @spec get_project_role_details(String.t(), keyword) ::
          {:ok, [Jirex.ProjectRoleDetails.t()]} | :error
  def get_project_role_details(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoles, :get_project_role_details},
      url: "/rest/api/2/project/#{projectIdOrKey}/roledetails",
      method: :get,
      query: query,
      response: [{200, [{Jirex.ProjectRoleDetails, :t}]}, {401, :null}, {404, :null}],
      opts: opts
    })
  end

  @type get_project_roles_200_json_resp :: %{}
  ...
  **[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for any project on the site or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def get_project_roles(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey],
      call: {Jirex.ProjectRoles, :get_project_roles},
      url: "/rest/api/2/project/#{projectIdOrKey}/role",
      method: :get,
      response: [
        {200, {Jirex.ProjectRoles, :get_project_roles_200_json_resp}},
        {401, :null},
        {404, :null}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec partial_update_project_role(integer, Jirex.CreateUpdateRoleRequestBean.t(), keyword) ::
          {:ok, Jirex.ProjectRole.t()} | :error
  def partial_update_project_role(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jirex.ProjectRoles, :partial_update_project_role},
      url: "/rest/api/2/role/#{id}",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.CreateUpdateRoleRequestBean, :t}}],
  ...
  def __fields__(:get_project_roles_200_json_resp) do
    []
  end
end
