defmodule Jirex.ProjectRoleActors do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_actor_users(String.t(), integer, Jirex.ActorsMap.t(), keyword) ::
  ...
  def add_actor_users(projectIdOrKey, id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoleActors, :add_actor_users},
      url: "/rest/api/2/project/#{projectIdOrKey}/role/#{id}",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.ActorsMap, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_project_role_actors_to_role(integer, Jirex.ActorInputBean.t(), keyword) ::
          {:ok, Jirex.ProjectRole.t()} | :error
  def add_project_role_actors_to_role(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoleActors, :add_project_role_actors_to_role},
      url: "/rest/api/2/role/#{id}/actors",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.ActorInputBean, :t}}],
      response: [
  ...
  **[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_actor(projectIdOrKey, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ProjectRoleActors, :delete_actor},
      url: "/rest/api/2/project/#{projectIdOrKey}/role/#{id}",
      method: :delete,
      query: query,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_project_role_actors_from_role(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectRoleActors, :delete_project_role_actors_from_role},
      url: "/rest/api/2/role/#{id}/actors",
      method: :delete,
      query: query,
      response: [
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def get_project_role_actors_for_role(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jirex.ProjectRoleActors, :get_project_role_actors_for_role},
      url: "/rest/api/2/role/#{id}/actors",
      method: :get,
      response: [
        {200, {Jirex.ProjectRole, :t}},
  ...
  **[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec set_actors(String.t(), integer, Jirex.ProjectRoleActorsUpdateBean.t(), keyword) ::
          {:ok, Jirex.ProjectRole.t()} | :error
  def set_actors(projectIdOrKey, id, body, opts \\ []) do
    ...
    client.request(%{
      args: [projectIdOrKey: projectIdOrKey, id: id, body: body],
      call: {Jirex.ProjectRoleActors, :set_actors},
      url: "/rest/api/2/project/#{projectIdOrKey}/role/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.ProjectRoleActorsUpdateBean, :t}}],
      response: [{200, {Jirex.ProjectRole, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
