defmodule Jirex.Workflows do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_workflow(Jirex.CreateWorkflowDetails.t(), keyword) ::
          {:ok, Jirex.WorkflowIDs.t()} | {:error, any}
  def create_workflow(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :create_workflow},
      url: "/rest/api/2/workflow",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.CreateWorkflowDetails, :t}}],
      response: [
        {201, {Jirex.WorkflowIDs, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec create_workflows(Jirex.WorkflowCreateRequest.t(), keyword) ::
          {:ok, Jirex.WorkflowCreateResponse.t()} | :error
  def create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :create_workflows},
      url: "/rest/api/2/workflows/create",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.WorkflowCreateRequest, :t}}],
      response: [{200, {Jirex.WorkflowCreateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec delete_inactive_workflow(String.t(), keyword) :: :ok | {:error, any}
  def delete_inactive_workflow(entityId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [entityId: entityId],
      call: {Jirex.Workflows, :delete_inactive_workflow},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_all_workflows(keyword) :: {:ok, [Jirex.DeprecatedWorkflow.t()]} | :error
  def get_all_workflows(opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:workflowName])

    client.request(%{
      args: [],
      call: {Jirex.Workflows, :get_all_workflows},
      url: "/rest/api/2/workflow",
      method: :get,
      query: query,
      response: [{200, [{Jirex.DeprecatedWorkflow, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_workflows_paginated(keyword) ::
          {:ok, Jirex.PageBeanWorkflow.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_workflows_paginated(opts \\ []) do
    client = opts[:client] || @default_client
    ...
    client.request(%{
      args: [],
      call: {Jirex.Workflows, :get_workflows_paginated},
      url: "/rest/api/2/workflow/search",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanWorkflow, :t}},
        {401, :null},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec read_workflows(Jirex.WorkflowReadRequest.t(), keyword) ::
          {:ok, Jirex.WorkflowReadResponse.t()} | :error
  def read_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:expand])

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :read_workflows},
      url: "/rest/api/2/workflows",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jirex.WorkflowReadRequest, :t}}],
      response: [{200, {Jirex.WorkflowReadResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec update_workflows(Jirex.WorkflowUpdateRequest.t(), keyword) ::
          {:ok, Jirex.WorkflowUpdateResponse.t()} | :error
  def update_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:expand])

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :update_workflows},
      url: "/rest/api/2/workflows/update",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jirex.WorkflowUpdateRequest, :t}}],
      response: [{200, {Jirex.WorkflowUpdateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_create_workflows(Jirex.WorkflowCreateValidateRequest.t(), keyword) ::
          {:ok, Jirex.WorkflowValidationErrorList.t()} | :error
  def validate_create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :validate_create_workflows},
      url: "/rest/api/2/workflows/create/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.WorkflowCreateValidateRequest, :t}}],
      response: [{200, {Jirex.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_update_workflows(Jirex.WorkflowUpdateValidateRequestBean.t(), keyword) ::
          {:ok, Jirex.WorkflowValidationErrorList.t()} | :error
  def validate_update_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.Workflows, :validate_update_workflows},
      url: "/rest/api/2/workflows/update/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.WorkflowUpdateValidateRequestBean, :t}}],
      response: [{200, {Jirex.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec workflow_capabilities(keyword) :: {:ok, Jirex.WorkflowCapabilities.t()} | :error
  def workflow_capabilities(opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:issueTypeId, :projectId, :workflowId])

    client.request(%{
      args: [],
      call: {Jirex.Workflows, :workflow_capabilities},
      url: "/rest/api/2/workflows/capabilities",
      method: :get,
      query: query,
      response: [{200, {Jirex.WorkflowCapabilities, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
end
