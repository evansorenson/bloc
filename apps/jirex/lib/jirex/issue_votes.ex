defmodule Jirex.IssueVotes do
  ...
  **[Permissions](#permissions) required:**
  ...
  def add_vote(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueVotes, :add_vote},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_votes(String.t(), keyword) :: {:ok, Jirex.Votes.t()} | :error
  def get_votes(issueIdOrKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jirex.IssueVotes, :get_votes},
      url: "/rest/api/2/issue/#{issueIdOrKey}/votes",
      method: :get,
      response: [{200, {Jirex.Votes, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  def remove_vote(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jirex.IssueVotes, :remove_vote},
      url: "/rest/api/2/issue/#{issueIdOrKey}/votes",
      method: :delete,
