defmodule Jira.SharePermissionProject do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          avatarUrls: map | nil,
          components: [Jira.ProjectComponent.t()] | nil,
          deleted: boolean | nil,
          deletedBy: map | nil,
          ...
          issueTypes: [Jira.IssueTypeDetails.t()] | nil,
          key: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      avatarUrls: :map,
      components: [{Jira.ProjectComponent, :t}],
      deleted: :boolean,
      deletedBy: :map,
      ...
      issueTypes: [{Jira.IssueTypeDetails, :t}],
      key: {:string, :generic},
      landingPageInfo: :map,
      lead: :map,
      name: {:string, :generic},
