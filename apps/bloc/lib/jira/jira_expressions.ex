defmodule Jira.JiraExpressions do
  @moduledoc """
  ...
  **[Permissions](#permissions) required**: None.
  ...
  """
  @spec analyse_expression(Jira.JiraExpressionForAnalysis.t(), keyword) ::
          {:ok, Jira.JiraExpressionsAnalysis.t()} | {:error, Jira.ErrorCollection.t()}
  def analyse_expression(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.JiraExpressions, :analyse_expression},
      url: "/rest/api/2/expression/analyse",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.JiraExpressionForAnalysis, :t}}],
      response: [
        {200, {Jira.JiraExpressionsAnalysis, :t}},
  ...
  **[Permissions](#permissions) required**: None. However, an expression may return different results for different users depending on their permissions. For example, different users may see different comments on the same issue.  
  ...
  """
  @spec evaluate_jira_expression(Jira.JiraExpressionEvalRequestBean.t(), keyword) ::
          {:ok, Jira.JiraExpressionResult.t()} | {:error, Jira.ErrorCollection.t()}
  def evaluate_jira_expression(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.JiraExpressions, :evaluate_jira_expression},
      url: "/rest/api/2/expression/eval",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.JiraExpressionEvalRequestBean, :t}}],
      response: [
        {200, {Jira.JiraExpressionResult, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, :null},
        {404, {Jira.ErrorCollection, :t}}
      ],
