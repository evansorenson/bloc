defmodule Jira.IssueWatchers do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:**
  ...
  def add_watcher(issueIdOrKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueWatchers, :add_watcher},
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec get_is_watching_issue_bulk(Jira.IssueList.t(), keyword) ::
          {:ok, Jira.BulkIssueIsWatching.t()} | :error
  def get_is_watching_issue_bulk(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueWatchers, :get_is_watching_issue_bulk},
      url: "/rest/api/2/issue/watching",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssueList, :t}}],
      response: [{200, {Jira.BulkIssueIsWatching, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_issue_watchers(String.t(), keyword) :: {:ok, Jira.Watchers.t()} | :error
  def get_issue_watchers(issueIdOrKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.IssueWatchers, :get_issue_watchers},
      url: "/rest/api/2/issue/#{issueIdOrKey}/watchers",
      method: :get,
      response: [{200, {Jira.Watchers, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  def remove_watcher(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.IssueWatchers, :remove_watcher},
      url: "/rest/api/2/issue/#{issueIdOrKey}/watchers",
      method: :delete,
      query: query,
