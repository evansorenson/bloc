defmodule Jira.Workflows do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_workflow(Jira.CreateWorkflowDetails.t(), keyword) ::
          {:ok, Jira.WorkflowIDs.t()} | {:error, any}
  def create_workflow(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :create_workflow},
      url: "/rest/api/2/workflow",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.CreateWorkflowDetails, :t}}],
      response: [
        {201, {Jira.WorkflowIDs, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec create_workflows(Jira.WorkflowCreateRequest.t(), keyword) ::
          {:ok, Jira.WorkflowCreateResponse.t()} | :error
  def create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :create_workflows},
      url: "/rest/api/2/workflows/create",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.WorkflowCreateRequest, :t}}],
      response: [{200, {Jira.WorkflowCreateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_inactive_workflow(entityId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.Workflows, :delete_inactive_workflow},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_all_workflows(keyword) :: {:ok, [Jira.DeprecatedWorkflow.t()]} | :error
  def get_all_workflows(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Workflows, :get_all_workflows},
      url: "/rest/api/2/workflow",
      method: :get,
      query: query,
      response: [{200, [{Jira.DeprecatedWorkflow, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_workflows_paginated(keyword) ::
          {:ok, Jira.PageBeanWorkflow.t()} | {:error, Jira.ErrorCollection.t()}
  def get_workflows_paginated(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Workflows, :get_workflows_paginated},
      url: "/rest/api/2/workflow/search",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanWorkflow, :t}},
        {401, :null},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec read_workflows(Jira.WorkflowReadRequest.t(), keyword) ::
          {:ok, Jira.WorkflowReadResponse.t()} | :error
  def read_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :read_workflows},
      url: "/rest/api/2/workflows",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.WorkflowReadRequest, :t}}],
      response: [{200, {Jira.WorkflowReadResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec update_workflows(Jira.WorkflowUpdateRequest.t(), keyword) ::
          {:ok, Jira.WorkflowUpdateResponse.t()} | :error
  def update_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :update_workflows},
      url: "/rest/api/2/workflows/update",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.WorkflowUpdateRequest, :t}}],
      response: [{200, {Jira.WorkflowUpdateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_create_workflows(Jira.WorkflowCreateValidateRequest.t(), keyword) ::
          {:ok, Jira.WorkflowValidationErrorList.t()} | :error
  def validate_create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :validate_create_workflows},
      url: "/rest/api/2/workflows/create/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.WorkflowCreateValidateRequest, :t}}],
      response: [{200, {Jira.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_update_workflows(Jira.WorkflowUpdateValidateRequestBean.t(), keyword) ::
          {:ok, Jira.WorkflowValidationErrorList.t()} | :error
  def validate_update_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Workflows, :validate_update_workflows},
      url: "/rest/api/2/workflows/update/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.WorkflowUpdateValidateRequestBean, :t}}],
      response: [{200, {Jira.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec workflow_capabilities(keyword) :: {:ok, Jira.WorkflowCapabilities.t()} | :error
  def workflow_capabilities(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Workflows, :workflow_capabilities},
      url: "/rest/api/2/workflows/capabilities",
      method: :get,
      query: query,
      response: [{200, {Jira.WorkflowCapabilities, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
end
