defmodule Jira.AuditRecords do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_audit_records(keyword) :: {:ok, map} | {:error, Jira.ErrorCollection.t()}
  def get_audit_records(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.AuditRecords, :get_audit_records},
      url: "/rest/api/2/auditing/record",
      method: :get,
      query: query,
      response: [
        {200, {Jira.AuditRecords, :t}},
  ...
  @type t :: %__MODULE__{
          limit: integer | nil,
          offset: integer | nil,
          records: [Jira.AuditRecordBean.t()] | nil,
          total: integer | nil
        }
  ...
  def __fields__(:t) do
    [limit: :integer, offset: :integer, records: [{Jira.AuditRecordBean, :t}], total: :integer]
  end
end
