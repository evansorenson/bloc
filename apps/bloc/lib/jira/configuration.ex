defmodule Jira.Configuration do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          timeTrackingConfiguration: Jira.ConfigurationTimeTrackingConfiguration.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      timeTrackingConfiguration: {Jira.ConfigurationTimeTrackingConfiguration, :t},
