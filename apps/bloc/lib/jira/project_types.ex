defmodule Jira.ProjectTypes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  """
  @spec get_all_accessible_project_types(keyword) :: {:ok, [Jira.ProjectType.t()]} | :error
  def get_all_accessible_project_types(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.ProjectTypes, :get_all_accessible_project_types},
      url: "/rest/api/2/project/type/accessible",
      method: :get,
      response: [{200, [{Jira.ProjectType, :t}]}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_all_project_types(keyword) :: {:ok, [Jira.ProjectType.t()]} | :error
  def get_all_project_types(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.ProjectTypes, :get_all_project_types},
      url: "/rest/api/2/project/type",
      method: :get,
      response: [{200, [{Jira.ProjectType, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_project_type_by_key(String.t(), keyword) :: {:ok, Jira.ProjectType.t()} | :error
  def get_project_type_by_key(projectTypeKey, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [projectTypeKey: projectTypeKey],
      call: {Jira.ProjectTypes, :get_project_type_by_key},
