defmodule Jira.ServerInformation do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          healthChecks: [Jira.HealthCheckResult.t()] | nil,
          scmInfo: String.t() | nil,
          serverTime: DateTime.t() | nil,
          serverTimeZone: Jira.ServerInformationServerTimeZone.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      healthChecks: [{Jira.HealthCheckResult, :t}],
      scmInfo: {:string, :generic},
      serverTime: {:string, :date_time},
      serverTimeZone: {Jira.ServerInformationServerTimeZone, :t},
