defmodule Jira.IssueTypeSchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_issue_types_to_issue_type_scheme(integer, Jira.IssueTypeIds.t(), keyword) ::
          {:ok, map} | {:error, any}
  def add_issue_types_to_issue_type_scheme(issueTypeSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypeSchemes, :add_issue_types_to_issue_type_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec assign_issue_type_scheme_to_project(Jira.IssueTypeSchemeProjectAssociation.t(), keyword) ::
          {:ok, map} | {:error, any}
  def assign_issue_type_scheme_to_project(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.IssueTypeSchemes, :assign_issue_type_scheme_to_project},
      url: "/rest/api/2/issuetypescheme/project",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.IssueTypeSchemeProjectAssociation, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_issue_type_scheme(Jira.IssueTypeSchemeDetails.t(), keyword) ::
          {:ok, Jira.IssueTypeSchemeID.t()} | {:error, any}
  def create_issue_type_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueTypeSchemes, :create_issue_type_scheme},
      url: "/rest/api/2/issuetypescheme",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssueTypeSchemeDetails, :t}}],
      response: [
        {201, {Jira.IssueTypeSchemeID, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {409, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_issue_type_scheme(issueTypeSchemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypeSchemes, :delete_issue_type_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_all_issue_type_schemes(keyword) :: {:ok, Jira.PageBeanIssueTypeScheme.t()} | :error
  def get_all_issue_type_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueTypeSchemes, :get_all_issue_type_schemes},
      url: "/rest/api/2/issuetypescheme",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanIssueTypeScheme, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_scheme_for_projects(keyword) ::
          {:ok, Jira.PageBeanIssueTypeSchemeProjects.t()} | :error
  def get_issue_type_scheme_for_projects(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueTypeSchemes, :get_issue_type_scheme_for_projects},
      url: "/rest/api/2/issuetypescheme/project",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanIssueTypeSchemeProjects, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_schemes_mapping(keyword) ::
          {:ok, Jira.PageBeanIssueTypeSchemeMapping.t()} | :error
  def get_issue_type_schemes_mapping(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueTypeSchemes, :get_issue_type_schemes_mapping},
      url: "/rest/api/2/issuetypescheme/mapping",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanIssueTypeSchemeMapping, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def remove_issue_type_from_issue_type_scheme(issueTypeSchemeId, issueTypeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypeSchemes, :remove_issue_type_from_issue_type_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec reorder_issue_types_in_issue_type_scheme(integer, Jira.OrderOfIssueTypes.t(), keyword) ::
          {:ok, map} | {:error, any}
  def reorder_issue_types_in_issue_type_scheme(issueTypeSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeSchemeId: issueTypeSchemeId, body: body],
      call: {Jira.IssueTypeSchemes, :reorder_issue_types_in_issue_type_scheme},
      url: "/rest/api/2/issuetypescheme/#{issueTypeSchemeId}/issuetype/move",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.OrderOfIssueTypes, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_issue_type_scheme(integer, Jira.IssueTypeSchemeUpdateDetails.t(), keyword) ::
          {:ok, map} | {:error, any}
  def update_issue_type_scheme(issueTypeSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeSchemeId: issueTypeSchemeId, body: body],
      call: {Jira.IssueTypeSchemes, :update_issue_type_scheme},
      url: "/rest/api/2/issuetypescheme/#{issueTypeSchemeId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.IssueTypeSchemeUpdateDetails, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
