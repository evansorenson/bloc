defmodule Jira.DeleteAndReplaceVersionBean do
  @moduledoc """
  Provides struct and type for a DeleteAndReplaceVersionBean
  """

  @type t :: %__MODULE__{
          customFieldReplacementList: [Jira.CustomFieldReplacement.t()] | nil,
  ...
  def __fields__(:t) do
    [
      customFieldReplacementList: [{Jira.CustomFieldReplacement, :t}],
