defmodule Jira.Issues do
  ...
  **Signed-in users only:** This API can't be accessed anonymously.
  ...
  """
  @spec archive_issues(Jira.IssueArchivalSyncRequest.t(), keyword) ::
          {:ok, Jira.IssueArchivalSyncResponse.t()} | {:error, any}
  def archive_issues(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :archive_issues},
      url: "/rest/api/2/issue/archive",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.IssueArchivalSyncRequest, :t}}],
      response: [
        {200, {Jira.IssueArchivalSyncResponse, :t}},
        {400, :unknown},
        {401, :unknown},
        {403, :unknown},
        {412, :unknown}
  ...
  **Rate limiting:** Only a single request per jira instance can be active at any given time.
  ...
  """
  @spec archive_issues_async(Jira.ArchiveIssueAsyncRequest.t(), keyword) ::
  ...
  def archive_issues_async(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :archive_issues_async},
      url: "/rest/api/2/issue/archive",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.ArchiveIssueAsyncRequest, :t}}],
      response: [
        {202, {:string, :generic}},
        {400, :unknown},
        {401, :unknown},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec assign_issue(String.t(), Jira.User.t(), keyword) :: {:ok, map} | :error
  def assign_issue(issueIdOrKey, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey, body: body],
      call: {Jira.Issues, :assign_issue},
      url: "/rest/api/2/issue/#{issueIdOrKey}/assignee",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.User, :t}}],
  ...
  **[Permissions](#permissions) required:** *Browse projects* and *Create issues* [project permissions](https://confluence.atlassian.com/x/yodKLg) for the project in which the issue or subtask is created.
  ...
  """
  @spec create_issue(Jira.IssueUpdateDetails.t(), keyword) ::
          {:ok, Jira.CreatedIssue.t()} | {:error, Jira.ErrorCollection.t()}
  def create_issue(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :create_issue},
      url: "/rest/api/2/issue",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.IssueUpdateDetails, :t}}],
      response: [
        {201, {Jira.CreatedIssue, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}},
        {403, {Jira.ErrorCollection, :t}},
        {422, {Jira.ErrorCollection, :t}}
      ],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse projects* and *Create issues* [project permissions](https://confluence.atlassian.com/x/yodKLg) for the project in which each issue or subtask is created.
  """
  @spec create_issues(Jira.IssuesUpdateBean.t(), keyword) ::
          {:ok, Jira.CreatedIssues.t()} | {:error, Jira.CreatedIssues.t()}
  def create_issues(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :create_issues},
      url: "/rest/api/2/issue/bulk",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssuesUpdateBean, :t}}],
      response: [{201, {Jira.CreatedIssues, :t}}, {400, {Jira.CreatedIssues, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec do_transition(String.t(), Jira.IssueUpdateDetails.t(), keyword) :: {:ok, map} | :error
  def do_transition(issueIdOrKey, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey, body: body],
      call: {Jira.Issues, :do_transition},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec edit_issue(String.t(), Jira.IssueUpdateDetails.t(), keyword) :: {:ok, map} | :error
  ...
  **Rate limiting:** Only a single request can be active at any given time.
  ...
  """
  @spec export_archived_issues(Jira.ArchivedIssuesFilterRequest.t(), keyword) ::
          {:ok, Jira.ExportArchivedIssuesTaskProgressResponse.t()} | {:error, any}
  def export_archived_issues(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :export_archived_issues},
      url: "/rest/api/2/issues/archive/export",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.ArchivedIssuesFilterRequest, :t}}],
      response: [
        {202, {Jira.ExportArchivedIssuesTaskProgressResponse, :t}},
        {400, :unknown},
        {401, :unknown},
        {403, :unknown},
        {412, :unknown}
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_change_logs(String.t(), keyword) :: {:ok, Jira.PageBeanChangelog.t()} | :error
  def get_change_logs(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.Issues, :get_change_logs},
      url: "/rest/api/2/issue/#{issueIdOrKey}/changelog",
      method: :get,
      query: query,
      response: [{200, {Jira.PageBeanChangelog, :t}}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec get_change_logs_by_ids(String.t(), Jira.IssueChangelogIds.t(), keyword) ::
          {:ok, Jira.PageOfChangelogs.t()} | :error
  def get_change_logs_by_ids(issueIdOrKey, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey, body: body],
      call: {Jira.Issues, :get_change_logs_by_ids},
      url: "/rest/api/2/issue/#{issueIdOrKey}/changelog/list",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssueChangelogIds, :t}}],
      response: [{200, {Jira.PageOfChangelogs, :t}}, {400, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Create issues* [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
  ...
  """
  @spec get_create_issue_meta(keyword) :: {:ok, Jira.IssueCreateMetadata.t()} | :error
  def get_create_issue_meta(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Issues, :get_create_issue_meta},
      url: "/rest/api/2/issue/createmeta",
      method: :get,
      query: query,
      response: [{200, {Jira.IssueCreateMetadata, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Create issues* [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
  ...
  @spec get_create_issue_meta_issue_type_id(String.t(), String.t(), keyword) ::
          {:ok, Jira.PageOfCreateMetaIssueTypeWithField.t()} | {:error, any}
  def get_create_issue_meta_issue_type_id(projectIdOrKey, issueTypeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.Issues, :get_create_issue_meta_issue_type_id},
      url: "/rest/api/2/issue/createmeta/#{projectIdOrKey}/issuetypes/#{issueTypeId}",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageOfCreateMetaIssueTypeWithField, :t}},
        {400, :unknown},
        {401, :null}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** *Create issues* [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
  ...
  @spec get_create_issue_meta_issue_types(String.t(), keyword) ::
          {:ok, Jira.PageOfCreateMetaIssueTypes.t()} | {:error, any}
  def get_create_issue_meta_issue_types(projectIdOrKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.Issues, :get_create_issue_meta_issue_types},
      url: "/rest/api/2/issue/createmeta/#{projectIdOrKey}/issuetypes",
      method: :get,
      query: query,
      response: [{200, {Jira.PageOfCreateMetaIssueTypes, :t}}, {400, :unknown}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_edit_issue_meta(String.t(), keyword) :: {:ok, Jira.IssueUpdateMetadata.t()} | :error
  def get_edit_issue_meta(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.Issues, :get_edit_issue_meta},
      url: "/rest/api/2/issue/#{issueIdOrKey}/editmeta",
      method: :get,
      query: query,
      response: [{200, {Jira.IssueUpdateMetadata, :t}}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_events(keyword) :: {:ok, [Jira.IssueEvent.t()]} | :error
  def get_events(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.Issues, :get_events},
      url: "/rest/api/2/events",
      method: :get,
      response: [{200, [{Jira.IssueEvent, :t}]}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_issue(String.t(), keyword) :: {:ok, Jira.IssueBean.t()} | :error
  def get_issue(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.Issues, :get_issue},
      url: "/rest/api/2/issue/#{issueIdOrKey}",
      method: :get,
      query: query,
      response: [{200, {Jira.IssueBean, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_issue_limit_report(Jira.IssueLimitReportRequest.t(), keyword) ::
          {:ok, Jira.IssueLimitReportResponseBean.t()} | :error
  def get_issue_limit_report(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :get_issue_limit_report},
      url: "/rest/api/2/issue/limit/report",
      body: body,
      method: :get,
      request: [{"application/json", {Jira.IssueLimitReportRequest, :t}}],
      response: [
        {200, {Jira.IssueLimitReportResponseBean, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required: A list or transition is returned only when the user has:**
  ...
  """
  @spec get_transitions(String.t(), keyword) :: {:ok, Jira.Transitions.t()} | :error
  def get_transitions(issueIdOrKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueIdOrKey: issueIdOrKey],
      call: {Jira.Issues, :get_transitions},
      url: "/rest/api/2/issue/#{issueIdOrKey}/transitions",
      method: :get,
      query: query,
      response: [{200, {Jira.Transitions, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec notify(String.t(), Jira.Notification.t(), keyword) :: {:ok, map} | :error
  def notify(issueIdOrKey, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueIdOrKey: issueIdOrKey, body: body],
      call: {Jira.Issues, :notify},
      url: "/rest/api/2/issue/#{issueIdOrKey}/notify",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.Notification, :t}}],
      response: [{204, :map}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **Signed-in users only:** This API can't be accessed anonymously.
  ...
  """
  @spec unarchive_issues(Jira.IssueArchivalSyncRequest.t(), keyword) ::
          {:ok, Jira.IssueArchivalSyncResponse.t()} | {:error, any}
  def unarchive_issues(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Issues, :unarchive_issues},
