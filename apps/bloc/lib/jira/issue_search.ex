defmodule Jira.IssueSearch do
  ...
  **[Permissions](#permissions) required:** None.
  ...
  """
  @spec get_issue_picker_resource(keyword) :: {:ok, Jira.IssuePickerSuggestions.t()} | :error
  def get_issue_picker_resource(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueSearch, :get_issue_picker_resource},
      url: "/rest/api/2/issue/picker",
      method: :get,
      query: query,
      response: [{200, {Jira.IssuePickerSuggestions, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None, however, issues are only matched against JQL queries where the user has:
  ...
  """
  @spec match_issues(Jira.IssuesAndJQLQueries.t(), keyword) ::
          {:ok, Jira.IssueMatches.t()} | :error
  def match_issues(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueSearch, :match_issues},
      url: "/rest/api/2/jql/match",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssuesAndJQLQueries, :t}}],
      response: [{200, {Jira.IssueMatches, :t}}, {400, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Issues are included in the response where the user has:
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec search_for_issues_ids(Jira.IdSearchRequestBean.t(), keyword) ::
          {:ok, Jira.IdSearchResults.t()} | :error
  def search_for_issues_ids(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueSearch, :search_for_issues_ids},
      url: "/rest/api/2/search/id",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IdSearchRequestBean, :t}}],
      response: [{200, {Jira.IdSearchResults, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Issues are included in the response where the user has:
  ...
  """
  @spec search_for_issues_using_jql(keyword) :: {:ok, Jira.SearchResults.t()} | :error
  def search_for_issues_using_jql(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueSearch, :search_for_issues_using_jql},
      url: "/rest/api/2/search",
      method: :get,
      query: query,
      response: [{200, {Jira.SearchResults, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Issues are included in the response where the user has:
   ...
   *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
  """
  @spec search_for_issues_using_jql_post(Jira.SearchRequestBean.t(), keyword) ::
          {:ok, Jira.SearchResults.t()} | :error
  def search_for_issues_using_jql_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueSearch, :search_for_issues_using_jql_post},
      url: "/rest/api/2/search",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.SearchRequestBean, :t}}],
      response: [{200, {Jira.SearchResults, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
