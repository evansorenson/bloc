defmodule Jira.IssueTypeProperties do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_issue_type_property(issueTypeId, propertyKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypeProperties, :delete_issue_type_property},
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_issue_type_property(issueTypeId, propertyKey, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeId: issueTypeId, propertyKey: propertyKey],
      call: {Jira.IssueTypeProperties, :get_issue_type_property},
      url: "/rest/api/2/issuetype/#{issueTypeId}/properties/#{propertyKey}",
      method: :get,
      response: [{200, {Jira.EntityProperty, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_issue_type_property_keys(String.t(), keyword) :: {:ok, Jira.PropertyKeys.t()} | :error
  def get_issue_type_property_keys(issueTypeId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [issueTypeId: issueTypeId],
      call: {Jira.IssueTypeProperties, :get_issue_type_property_keys},
      url: "/rest/api/2/issuetype/#{issueTypeId}/properties",
      method: :get,
      response: [{200, {Jira.PropertyKeys, :t}}, {400, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def set_issue_type_property(issueTypeId, propertyKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypeProperties, :set_issue_type_property},
      url: "/rest/api/2/issuetype/#{issueTypeId}/properties/#{propertyKey}",
      body: body,
      method: :put,
