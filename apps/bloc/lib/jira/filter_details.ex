defmodule Jira.FilterDetails do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          jql: String.t() | nil,
          name: String.t(),
          owner: Jira.FilterDetailsOwner.t() | nil,
          searchUrl: String.t() | nil,
          self: String.t() | nil,
          sharePermissions: [Jira.SharePermission.t()] | nil,
          subscriptions: [Jira.FilterSubscription.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      jql: {:string, :generic},
      name: {:string, :generic},
      owner: {Jira.FilterDetailsOwner, :t},
      searchUrl: {:string, :uri},
      self: {:string, :uri},
      sharePermissions: [{Jira.SharePermission, :t}],
      subscriptions: [{Jira.FilterSubscription, :t}],
      viewUrl: {:string, :uri}
    ]
  end
end
