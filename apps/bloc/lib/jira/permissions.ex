defmodule Jira.Permissions do
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_all_permissions(keyword) :: {:ok, Jira.Permissions.t()} | :error
  def get_all_permissions(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.Permissions, :get_all_permissions},
      url: "/rest/api/2/permissions",
      method: :get,
      response: [{200, {Jira.Permissions, :t}}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) to check the permissions for other users, otherwise none. However, Connect apps can make a call from the app server to the product to obtain permission details for any user, without admin permission. This Connect app ability doesn't apply to calls made using AP.request() in a browser.
  """
  @spec get_bulk_permissions(Jira.BulkPermissionsRequestBean.t(), keyword) ::
          {:ok, Jira.BulkPermissionGrants.t()} | {:error, Jira.ErrorCollection.t()}
  def get_bulk_permissions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Permissions, :get_bulk_permissions},
      url: "/rest/api/2/permissions/check",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.BulkPermissionsRequestBean, :t}}],
      response: [
        {200, {Jira.BulkPermissionGrants, :t}},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_my_permissions(keyword) ::
          {:ok, Jira.Permissions.t()} | {:error, Jira.ErrorCollection.t()}
  def get_my_permissions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Permissions, :get_my_permissions},
      url: "/rest/api/2/mypermissions",
      method: :get,
      query: query,
      response: [
        {200, {Jira.Permissions, :t}},
        {400, {Jira.ErrorCollection, :t}},
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_permitted_projects(Jira.PermissionsKeysBean.t(), keyword) ::
          {:ok, Jira.PermittedProjects.t()} | :error
  def get_permitted_projects(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Permissions, :get_permitted_projects},
      url: "/rest/api/2/permissions/project",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.PermissionsKeysBean, :t}}],
      response: [{200, {Jira.PermittedProjects, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end

  @type t :: %__MODULE__{permissions: Jira.PermissionsPermissions.t() | nil}
  ...
  def __fields__(:t) do
    [permissions: {Jira.PermissionsPermissions, :t}]
  end
end
