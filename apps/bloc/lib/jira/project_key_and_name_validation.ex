defmodule Jira.ProjectKeyAndNameValidation do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def get_valid_project_key(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.ProjectKeyAndNameValidation, :get_valid_project_key},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def get_valid_project_name(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.ProjectKeyAndNameValidation, :get_valid_project_name},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  """
  @spec validate_project_key(keyword) :: {:ok, Jira.ErrorCollection.t()} | :error
  def validate_project_key(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.ProjectKeyAndNameValidation, :validate_project_key},
      url: "/rest/api/2/projectvalidate/key",
      method: :get,
      query: query,
      response: [{200, {Jira.ErrorCollection, :t}}, {401, :null}],
      opts: opts
    })
  end
end
