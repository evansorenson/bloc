defmodule Jira.ScreenTabFields do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_screen_tab_field(integer, integer, Jira.AddFieldBean.t(), keyword) ::
  ...
  def add_screen_tab_field(screenId, tabId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.ScreenTabFields, :add_screen_tab_field},
      url: "/rest/api/2/screens/#{screenId}/tabs/#{tabId}/fields",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.AddFieldBean, :t}}],
      response: [
        {200, {Jira.ScreenableField, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null}
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_all_screen_tab_fields(screenId, tabId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.ScreenTabFields, :get_all_screen_tab_fields},
      url: "/rest/api/2/screens/#{screenId}/tabs/#{tabId}/fields",
      method: :get,
      query: query,
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec move_screen_tab_field(integer, integer, String.t(), Jira.MoveFieldBean.t(), keyword) ::
          {:ok, map} | :error
  def move_screen_tab_field(screenId, tabId, id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.ScreenTabFields, :move_screen_tab_field},
      url: "/rest/api/2/screens/#{screenId}/tabs/#{tabId}/fields/#{id}/move",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.MoveFieldBean, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def remove_screen_tab_field(screenId, tabId, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.ScreenTabFields, :remove_screen_tab_field},
