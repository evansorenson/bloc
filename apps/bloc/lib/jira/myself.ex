defmodule Jira.Myself do
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def delete_locale(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Myself, :delete_locale},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  """
  @spec get_current_user(keyword) :: {:ok, Jira.User.t()} | :error
  def get_current_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Myself, :get_current_user},
      url: "/rest/api/2/myself",
      method: :get,
      query: query,
      response: [{200, {Jira.User, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_locale(keyword) :: {:ok, Jira.Locale.t()} | :error
  def get_locale(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.Myself, :get_locale},
      url: "/rest/api/2/mypreferences/locale",
      method: :get,
      response: [{200, {Jira.Locale, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_preference(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Myself, :get_preference},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def remove_preference(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Myself, :remove_preference},
      url: "/rest/api/2/mypreferences",
      method: :delete,
      query: query,
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  """
  @spec set_locale(Jira.Locale.t(), keyword) :: {:ok, map} | :error
  def set_locale(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Myself, :set_locale},
      url: "/rest/api/2/mypreferences/locale",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.Locale, :t}}],
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def set_preference(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Myself, :set_preference},
      url: "/rest/api/2/mypreferences",
      body: body,
      method: :put,
      query: query,
