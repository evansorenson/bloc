defmodule Jira.PermissionSchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec create_permission_grant(integer, Jira.PermissionGrant.t(), keyword) ::
          {:ok, Jira.PermissionGrant.t()} | :error
  def create_permission_grant(schemeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.PermissionSchemes, :create_permission_grant},
      url: "/rest/api/2/permissionscheme/#{schemeId}/permission",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.PermissionGrant, :t}}],
      response: [{201, {Jira.PermissionGrant, :t}}, {400, :null}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec create_permission_scheme(Jira.PermissionScheme.t(), keyword) ::
          {:ok, Jira.PermissionScheme.t()} | :error
  def create_permission_scheme(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.PermissionSchemes, :create_permission_scheme},
      url: "/rest/api/2/permissionscheme",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.PermissionScheme, :t}}],
      response: [{201, {Jira.PermissionScheme, :t}}, {400, :null}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_permission_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.PermissionSchemes, :delete_permission_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_permission_scheme_entity(schemeId, permissionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.PermissionSchemes, :delete_permission_scheme_entity},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_all_permission_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.PermissionSchemes, :get_all_permission_schemes},
      url: "/rest/api/2/permissionscheme",
      method: :get,
      query: query,
      response: [{200, {Jira.PermissionSchemes, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  """
  @spec get_permission_scheme(integer, keyword) :: {:ok, Jira.PermissionScheme.t()} | :error
  def get_permission_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId],
      call: {Jira.PermissionSchemes, :get_permission_scheme},
      url: "/rest/api/2/permissionscheme/#{schemeId}",
      method: :get,
      query: query,
      response: [{200, {Jira.PermissionScheme, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_permission_scheme_grant(schemeId, permissionId, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId, permissionId: permissionId],
      call: {Jira.PermissionSchemes, :get_permission_scheme_grant},
      url: "/rest/api/2/permissionscheme/#{schemeId}/permission/#{permissionId}",
      method: :get,
      query: query,
      response: [{200, {Jira.PermissionGrant, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  @spec get_permission_scheme_grants(integer, keyword) ::
          {:ok, Jira.PermissionGrants.t()} | :error
  def get_permission_scheme_grants(schemeId, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId],
      call: {Jira.PermissionSchemes, :get_permission_scheme_grants},
      url: "/rest/api/2/permissionscheme/#{schemeId}/permission",
      method: :get,
      query: query,
      response: [{200, {Jira.PermissionGrants, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec update_permission_scheme(integer, Jira.PermissionScheme.t(), keyword) ::
          {:ok, Jira.PermissionScheme.t()} | :error
  def update_permission_scheme(schemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId, body: body],
      call: {Jira.PermissionSchemes, :update_permission_scheme},
      url: "/rest/api/2/permissionscheme/#{schemeId}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", {Jira.PermissionScheme, :t}}],
      response: [{200, {Jira.PermissionScheme, :t}}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end

  @type t :: %__MODULE__{permissionSchemes: [Jira.PermissionScheme.t()] | nil}
  ...
  def __fields__(:t) do
    [permissionSchemes: [{Jira.PermissionScheme, :t}]]
  end
end
