defmodule Jira.ComponentWithIssueCount do
  @moduledoc """
  Provides struct and type for a ComponentWithIssueCount
  """

  @type t :: %__MODULE__{
          assignee: Jira.ComponentWithIssueCountAssignee.t() | nil,
          assigneeType: String.t() | nil,
          description: String.t() | nil,
          id: String.t() | nil,
          isAssigneeTypeValid: boolean | nil,
          issueCount: integer | nil,
          lead: Jira.ComponentWithIssueCountLead.t() | nil,
          name: String.t() | nil,
          project: String.t() | nil,
          projectId: integer | nil,
          realAssignee: Jira.ComponentWithIssueCountRealAssignee.t() | nil,
  ...
  def __fields__(:t) do
    [
      assignee: {Jira.ComponentWithIssueCountAssignee, :t},
      assigneeType: {:enum, ["PROJECT_DEFAULT", "COMPONENT_LEAD", "PROJECT_LEAD", "UNASSIGNED"]},
      description: {:string, :generic},
      id: {:string, :generic},
      isAssigneeTypeValid: :boolean,
      issueCount: :integer,
      lead: {Jira.ComponentWithIssueCountLead, :t},
      name: {:string, :generic},
      project: {:string, :generic},
      projectId: :integer,
      realAssignee: {Jira.ComponentWithIssueCountRealAssignee, :t},
      realAssigneeType:
