defmodule Jira.IssueFields do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_custom_field(Jira.CustomFieldDefinitionJsonBean.t(), keyword) ::
          {:ok, Jira.FieldDetails.t()} | :error
  def create_custom_field(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueFields, :create_custom_field},
      url: "/rest/api/2/field",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.CustomFieldDefinitionJsonBean, :t}}],
      response: [{201, {Jira.FieldDetails, :t}}, {400, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec delete_custom_field(String.t(), keyword) :: :ok | {:error, Jira.ErrorCollection.t()}
  def delete_custom_field(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jira.IssueFields, :delete_custom_field},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_contexts_for_field_deprecated(String.t(), keyword) ::
          {:ok, Jira.PageBeanContext.t()} | :error
  def get_contexts_for_field_deprecated(fieldId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueFields, :get_contexts_for_field_deprecated},
      url: "/rest/api/2/field/#{fieldId}/contexts",
      method: :get,
      query: query,
      response: [{200, {Jira.PageBeanContext, :t}}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  """
  @spec get_fields(keyword) :: {:ok, [Jira.FieldDetails.t()]} | :error
  def get_fields(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.IssueFields, :get_fields},
      url: "/rest/api/2/field",
      method: :get,
      response: [{200, [{Jira.FieldDetails, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_fields_paginated(keyword) ::
          {:ok, Jira.PageBeanField.t()} | {:error, Jira.ErrorCollection.t()}
  def get_fields_paginated(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueFields, :get_fields_paginated},
      url: "/rest/api/2/field/search",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanField, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, :null},
        {403, {Jira.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def get_trashed_fields_paginated(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueFields, :get_trashed_fields_paginated},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def restore_custom_field(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jira.IssueFields, :restore_custom_field},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec trash_custom_field(String.t(), keyword) :: {:ok, map} | {:error, Jira.ErrorCollection.t()}
  def trash_custom_field(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jira.IssueFields, :trash_custom_field},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_custom_field(String.t(), Jira.UpdateCustomFieldDetails.t(), keyword) ::
          {:ok, map} | {:error, any}
  def update_custom_field(fieldId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueFields, :update_custom_field},
      url: "/rest/api/2/field/#{fieldId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.UpdateCustomFieldDetails, :t}}],
