defmodule Jira.PrioritySchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_priority_scheme(Jira.CreatePrioritySchemeDetails.t(), keyword) ::
          {:ok, Jira.PrioritySchemeId.t()} | :error
  def create_priority_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.PrioritySchemes, :create_priority_scheme},
      url: "/rest/api/2/priorityscheme",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.CreatePrioritySchemeDetails, :t}}],
      response: [
        {201, {Jira.PrioritySchemeId, :t}},
        {202, {Jira.PrioritySchemeId, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {409, :null}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_priority_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.PrioritySchemes, :delete_priority_scheme},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  @spec get_available_priorities_by_priority_scheme(keyword) ::
          {:ok, Jira.PageBeanPriorityWithSequence.t()} | :error
  def get_available_priorities_by_priority_scheme(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.PrioritySchemes, :get_available_priorities_by_priority_scheme},
      url: "/rest/api/2/priorityscheme/priorities/available",
      method: :get,
      query: query,
      response: [{200, {Jira.PageBeanPriorityWithSequence, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_priorities_by_priority_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId],
      call: {Jira.PrioritySchemes, :get_priorities_by_priority_scheme},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  @spec get_priority_schemes(keyword) ::
          {:ok, Jira.PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects.t()} | :error
  def get_priority_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.PrioritySchemes, :get_priority_schemes},
      url: "/rest/api/2/priorityscheme",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects, :t}},
        {400, :null},
        {401, :null}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  @spec get_projects_by_priority_scheme(String.t(), keyword) ::
          {:ok, Jira.PageBeanProject.t()} | :error
  def get_projects_by_priority_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId],
      call: {Jira.PrioritySchemes, :get_projects_by_priority_scheme},
      url: "/rest/api/2/priorityscheme/#{schemeId}/projects",
      method: :get,
      query: query,
      response: [{200, {Jira.PageBeanProject, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  """
  @spec suggested_priorities_for_mappings(Jira.SuggestedMappingsRequestBean.t(), keyword) ::
          {:ok, Jira.PageBeanPriorityWithSequence.t()} | :error
  def suggested_priorities_for_mappings(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.PrioritySchemes, :suggested_priorities_for_mappings},
      url: "/rest/api/2/priorityscheme/mappings",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.SuggestedMappingsRequestBean, :t}}],
      response: [{200, {Jira.PageBeanPriorityWithSequence, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_priority_scheme(integer, Jira.UpdatePrioritySchemeRequestBean.t(), keyword) ::
          {:ok, Jira.UpdatePrioritySchemeResponseBean.t()} | :error
  def update_priority_scheme(schemeId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [schemeId: schemeId, body: body],
      call: {Jira.PrioritySchemes, :update_priority_scheme},
      url: "/rest/api/2/priorityscheme/#{schemeId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.UpdatePrioritySchemeRequestBean, :t}}],
      response: [
        {202, {Jira.UpdatePrioritySchemeResponseBean, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {409, :null}
