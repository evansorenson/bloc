defmodule Jira.Groups do
  ...
  **[Permissions](#permissions) required:** Site administration (that is, member of the *site-admin* [group](https://confluence.atlassian.com/x/24xjL)).
  ...
  """
  @spec add_user_to_group(Jira.UpdateUserToGroupBean.t(), keyword) ::
          {:ok, Jira.Group.t()} | :error
  def add_user_to_group(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.Groups, :add_user_to_group},
      url: "/rest/api/2/group/user",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.UpdateUserToGroupBean, :t}}],
      response: [{201, {Jira.Group, :t}}, {400, :null}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec bulk_get_groups(keyword) :: {:ok, Jira.PageBeanGroupDetails.t()} | {:error, any}
  def bulk_get_groups(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Groups, :bulk_get_groups},
      url: "/rest/api/2/group/bulk",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanGroupDetails, :t}},
        {400, :null},
        {401, :null},
        {403, :unknown},
        {500, :unknown}
  ...
  **[Permissions](#permissions) required:** Site administration (that is, member of the *site-admin* [group](https://confluence.atlassian.com/x/24xjL)).
  """
  @spec create_group(Jira.AddGroupBean.t(), keyword) :: {:ok, Jira.Group.t()} | :error
  def create_group(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Groups, :create_group},
      url: "/rest/api/2/group",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.AddGroupBean, :t}}],
      response: [{201, {Jira.Group, :t}}, {400, :null}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg). Without this permission, calls where query is not an exact match to an existing group will return an empty list.
  ...
  """
  @spec find_groups(keyword) :: {:ok, Jira.FoundGroups.t()} | :error
  def find_groups(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Groups, :find_groups},
      url: "/rest/api/2/groups/picker",
      method: :get,
      query: query,
      response: [{200, {Jira.FoundGroups, :t}}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** either of:
  ...
  """
  @spec get_group(keyword) :: {:ok, Jira.Group.t()} | :error
  def get_group(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Groups, :get_group},
      url: "/rest/api/2/group",
      method: :get,
      query: query,
      response: [{200, {Jira.Group, :t}}, {400, :null}, {401, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** either of:
  ...
  """
  @spec get_users_from_group(keyword) :: {:ok, Jira.PageBeanUserDetails.t()} | :error
  def get_users_from_group(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Groups, :get_users_from_group},
      url: "/rest/api/2/group/member",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanUserDetails, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null}
  ...
  **[Permissions](#permissions) required:** Site administration (that is, member of the *site-admin* [group](https://confluence.atlassian.com/x/24xjL)).
  ...
  def remove_user_from_group(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Groups, :remove_user_from_group},
      url: "/rest/api/2/group/user",
      method: :delete,
      query: query,
      response: [{200, :null}, {400, :null}, {401, :null}, {403, :null}, {404, :null}],
