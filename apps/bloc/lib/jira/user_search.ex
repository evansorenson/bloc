defmodule Jira.UserSearch do
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg) or *Assign issues* [project permission](https://confluence.atlassian.com/x/yodKLg)
  ...
  """
  @spec find_assignable_users(keyword) :: {:ok, [Jira.User.t()]} | :error
  def find_assignable_users(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_assignable_users},
      url: "/rest/api/2/user/assignable/search",
      method: :get,
      query: query,
      response: [{200, [{Jira.User, :t}]}, {400, :null}, {401, :null}, {404, :null}, {429, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** None.
  ...
  """
  @spec find_bulk_assignable_users(keyword) :: {:ok, [Jira.User.t()]} | :error
  def find_bulk_assignable_users(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_bulk_assignable_users},
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec find_user_keys_by_query(keyword) ::
          {:ok, Jira.PageBeanUserKey.t()} | {:error, Jira.ErrorCollection.t()}
  def find_user_keys_by_query(opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:maxResult, :query, :startAt])

    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_user_keys_by_query},
      url: "/rest/api/2/user/search/query/key",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanUserKey, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}},
        {403, {Jira.ErrorCollection, :t}},
        {408, {Jira.ErrorCollection, :t}}
      ],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg). Anonymous calls or calls by users without the required permission return empty search results.
  ...
  """
  @spec find_users(keyword) :: {:ok, [Jira.User.t()]} | :error
  def find_users(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_users},
      url: "/rest/api/2/user/search",
      method: :get,
      query: query,
      response: [{200, [{Jira.User, :t}]}, {400, :null}, {401, :null}, {429, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec find_users_by_query(keyword) ::
          {:ok, Jira.PageBeanUser.t()} | {:error, Jira.ErrorCollection.t()}
  def find_users_by_query(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_users_by_query},
      url: "/rest/api/2/user/search/query",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanUser, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}},
        {403, {Jira.ErrorCollection, :t}},
        {408, {Jira.ErrorCollection, :t}}
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg). Anonymous calls and calls by users without the required permission return search results for an exact name match only.
  ...
  """
  @spec find_users_for_picker(keyword) :: {:ok, Jira.FoundUsers.t()} | :error
  def find_users_for_picker(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_users_for_picker},
      url: "/rest/api/2/user/picker",
      method: :get,
      query: query,
      response: [{200, {Jira.FoundUsers, :t}}, {400, :null}, {401, :null}, {429, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec find_users_with_all_permissions(keyword) :: {:ok, [Jira.User.t()]} | :error
  def find_users_with_all_permissions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_users_with_all_permissions},
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg). Anonymous calls and calls by users without the required permission return empty search results.
  ...
  """
  @spec find_users_with_browse_permission(keyword) :: {:ok, [Jira.User.t()]} | :error
  def find_users_with_browse_permission(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.UserSearch, :find_users_with_browse_permission},
