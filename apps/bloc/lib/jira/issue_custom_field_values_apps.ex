defmodule Jira.IssueCustomFieldValuesApps do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** Only the app that owns the custom field or custom field type can update its values with this operation.
  ...
  """
  @spec update_custom_field_value(String.t(), Jira.CustomFieldValueUpdateDetails.t(), keyword) ::
          {:ok, map} | :error
  def update_custom_field_value(fieldIdOrKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueCustomFieldValuesApps, :update_custom_field_value},
      url: "/rest/api/2/app/field/#{fieldIdOrKey}/value",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", {Jira.CustomFieldValueUpdateDetails, :t}}],
  ...
  **[Permissions](#permissions) required:** Only the app that owns the custom field or custom field type can update its values with this operation.
  ...
  @spec update_multiple_custom_field_values(
          Jira.MultipleCustomFieldValuesUpdateDetails.t(),
          keyword
        ) :: {:ok, map} | :error
  def update_multiple_custom_field_values(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jira.IssueCustomFieldValuesApps, :update_multiple_custom_field_values},
      url: "/rest/api/2/app/field/value",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.MultipleCustomFieldValuesUpdateDetails, :t}}],
      response: [{204, :map}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
