defmodule Jira.IssueTypes do
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_issue_type(Jira.IssueTypeCreateBean.t(), keyword) ::
          {:ok, Jira.IssueTypeDetails.t()} | :error
  def create_issue_type(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueTypes, :create_issue_type},
      url: "/rest/api/2/issuetype",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.IssueTypeCreateBean, :t}}],
      response: [
        {201, {Jira.IssueTypeDetails, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {409, :null}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec create_issue_type_avatar(String.t(), map, keyword) :: {:ok, Jira.Avatar.t()} | :error
  def create_issue_type_avatar(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueTypes, :create_issue_type_avatar},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_issue_type(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jira.IssueTypes, :delete_issue_type},
  ...
  **[Permissions](#permissions) required:** None.
  ...
  def get_alternative_issue_types(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jira.IssueTypes, :get_alternative_issue_types},
      url: "/rest/api/2/issuetype/#{id}/alternatives",
      method: :get,
      response: [{200, [{Jira.IssueTypeDetails, :t}]}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Issue types are only returned as follows:
  ...
  """
  @spec get_issue_all_types(keyword) :: {:ok, [Jira.IssueTypeDetails.t()]} | :error
  def get_issue_all_types(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jira.IssueTypes, :get_issue_all_types},
      url: "/rest/api/2/issuetype",
      method: :get,
      response: [{200, [{Jira.IssueTypeDetails, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) in a project the issue type is associated with or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_issue_type(String.t(), keyword) :: {:ok, Jira.IssueTypeDetails.t()} | :error
  def get_issue_type(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jira.IssueTypes, :get_issue_type},
      url: "/rest/api/2/issuetype/#{id}",
      method: :get,
      response: [{200, {Jira.IssueTypeDetails, :t}}, {400, :null}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) in the relevant project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_issue_types_for_project(keyword) :: {:ok, [Jira.IssueTypeDetails.t()]} | :error
  def get_issue_types_for_project(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueTypes, :get_issue_types_for_project},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_issue_type(String.t(), Jira.IssueTypeUpdateBean.t(), keyword) ::
          {:ok, Jira.IssueTypeDetails.t()} | :error
  def update_issue_type(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jira.IssueTypes, :update_issue_type},
      url: "/rest/api/2/issuetype/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.IssueTypeUpdateBean, :t}}],
      response: [
        {200, {Jira.IssueTypeDetails, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null},
