defmodule Jira.IssueCustomFieldContexts do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_issue_types_to_context(String.t(), integer, Jira.IssueTypeIds.t(), keyword) ::
          {:ok, map} | {:error, any}
  def add_issue_types_to_context(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueCustomFieldContexts, :add_issue_types_to_context},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec assign_projects_to_custom_field_context(String.t(), integer, Jira.ProjectIds.t(), keyword) ::
          {:ok, map} | {:error, any}
  def assign_projects_to_custom_field_context(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jira.IssueCustomFieldContexts, :assign_projects_to_custom_field_context},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}/project",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.ProjectIds, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_custom_field_context(String.t(), Jira.CreateCustomFieldContext.t(), keyword) ::
          {:ok, Jira.CreateCustomFieldContext.t()} | {:error, any}
  def create_custom_field_context(fieldId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fieldId: fieldId, body: body],
      call: {Jira.IssueCustomFieldContexts, :create_custom_field_context},
      url: "/rest/api/2/field/#{fieldId}/context",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.CreateCustomFieldContext, :t}}],
      response: [
        {201, {Jira.CreateCustomFieldContext, :t}},
        {400, :null},
        {401, :null},
        {404, :null},
        {409, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec delete_custom_field_context(String.t(), integer, keyword) :: {:ok, map} | {:error, any}
  def delete_custom_field_context(fieldId, contextId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fieldId: fieldId, contextId: contextId],
      call: {Jira.IssueCustomFieldContexts, :delete_custom_field_context},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_contexts_for_field(String.t(), keyword) ::
          {:ok, Jira.PageBeanCustomFieldContext.t()} | {:error, any}
  def get_contexts_for_field(fieldId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueCustomFieldContexts, :get_contexts_for_field},
      url: "/rest/api/2/field/#{fieldId}/context",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanCustomFieldContext, :t}},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_custom_field_contexts_for_projects_and_issue_types(
          String.t(),
          Jira.ProjectIssueTypeMappings.t(),
          keyword
        ) :: {:ok, Jira.PageBeanContextForProjectAndIssueType.t()} | {:error, any}
  def get_custom_field_contexts_for_projects_and_issue_types(fieldId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, body: body],
      call:
        {Jira.IssueCustomFieldContexts, :get_custom_field_contexts_for_projects_and_issue_types},
      url: "/rest/api/2/field/#{fieldId}/context/mapping",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jira.ProjectIssueTypeMappings, :t}}],
      response: [
        {200, {Jira.PageBeanContextForProjectAndIssueType, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_default_values(String.t(), keyword) ::
          {:ok, Jira.PageBeanCustomFieldContextDefaultValue.t()} | {:error, any}
  def get_default_values(fieldId, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId],
      call: {Jira.IssueCustomFieldContexts, :get_default_values},
      url: "/rest/api/2/field/#{fieldId}/context/defaultValue",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanCustomFieldContextDefaultValue, :t}},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_mappings_for_contexts(String.t(), keyword) ::
          {:ok, Jira.PageBeanIssueTypeToContextMapping.t()} | {:error, any}
  def get_issue_type_mappings_for_contexts(fieldId, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId],
      call: {Jira.IssueCustomFieldContexts, :get_issue_type_mappings_for_contexts},
      url: "/rest/api/2/field/#{fieldId}/context/issuetypemapping",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanIssueTypeToContextMapping, :t}},
        {401, :null},
        {403, :unknown}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_project_context_mapping(String.t(), keyword) ::
          {:ok, Jira.PageBeanCustomFieldContextProjectMapping.t()} | {:error, any}
  def get_project_context_mapping(fieldId, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId],
      call: {Jira.IssueCustomFieldContexts, :get_project_context_mapping},
      url: "/rest/api/2/field/#{fieldId}/context/projectmapping",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanCustomFieldContextProjectMapping, :t}},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def remove_custom_field_context_from_projects(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jira.IssueCustomFieldContexts, :remove_custom_field_context_from_projects},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec remove_issue_types_from_context(String.t(), integer, Jira.IssueTypeIds.t(), keyword) ::
          {:ok, map} | {:error, any}
  def remove_issue_types_from_context(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jira.IssueCustomFieldContexts, :remove_issue_types_from_context},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec set_default_values(String.t(), Jira.CustomFieldContextDefaultValueUpdate.t(), keyword) ::
          {:ok, map} | {:error, any}
  def set_default_values(fieldId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, body: body],
      call: {Jira.IssueCustomFieldContexts, :set_default_values},
      url: "/rest/api/2/field/#{fieldId}/context/defaultValue",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.CustomFieldContextDefaultValueUpdate, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec update_custom_field_context(
          String.t(),
          integer,
          Jira.CustomFieldContextUpdateDetails.t(),
          keyword
        ) :: {:ok, map} | {:error, any}
  def update_custom_field_context(fieldId, contextId, body, opts \\ []) do
    ...
    client.request(%{
      args: [fieldId: fieldId, contextId: contextId, body: body],
      call: {Jira.IssueCustomFieldContexts, :update_custom_field_context},
      url: "/rest/api/2/field/#{fieldId}/context/#{contextId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.CustomFieldContextUpdateDetails, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
