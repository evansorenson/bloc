defmodule Jira.IssueNotificationSchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_notifications(String.t(), Jira.AddNotificationsDetails.t(), keyword) ::
  ...
  def add_notifications(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueNotificationSchemes, :add_notifications},
      url: "/rest/api/2/notificationscheme/#{id}/notification",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.AddNotificationsDetails, :t}}],
      response: [
        {204, :map},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_notification_scheme(Jira.CreateNotificationSchemeDetails.t(), keyword) ::
          {:ok, Jira.NotificationSchemeId.t()} | {:error, Jira.ErrorCollection.t()}
  def create_notification_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.IssueNotificationSchemes, :create_notification_scheme},
      url: "/rest/api/2/notificationscheme",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.CreateNotificationSchemeDetails, :t}}],
      response: [
        {201, {Jira.NotificationSchemeId, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}},
        {403, {Jira.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_notification_scheme(notificationSchemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueNotificationSchemes, :delete_notification_scheme},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira, however, the user must have permission to administer at least one project associated with the notification scheme.
  ...
  """
  @spec get_notification_scheme(integer, keyword) :: {:ok, Jira.NotificationScheme.t()} | :error
  def get_notification_scheme(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Jira.IssueNotificationSchemes, :get_notification_scheme},
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  @spec get_notification_scheme_to_project_mappings(keyword) ::
          {:ok, Jira.PageBeanNotificationSchemeAndProjectMappingJsonBean.t()}
  ...
  def get_notification_scheme_to_project_mappings(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueNotificationSchemes, :get_notification_scheme_to_project_mappings},
      url: "/rest/api/2/notificationscheme/project",
      method: :get,
      query: query,
      response: [
        {200, {Jira.PageBeanNotificationSchemeAndProjectMappingJsonBean, :t}},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}}
      ],
      opts: opts
  ...
  **[Permissions](#permissions) required:** Permission to access Jira, however, the user must have permission to administer at least one project associated with a notification scheme for it to be returned.
  ...
  @spec get_notification_schemes(keyword) ::
          {:ok, Jira.PageBeanNotificationScheme.t()} | {:error, any}
  def get_notification_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.IssueNotificationSchemes, :get_notification_schemes},
      url: "/rest/api/2/notificationscheme",
      method: :get,
      query: query,
      response: [{200, {Jira.PageBeanNotificationScheme, :t}}, {400, :unknown}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def remove_notification_from_notification_scheme(
    ...
    client.request(%{
      ...
      call: {Jira.IssueNotificationSchemes, :remove_notification_from_notification_scheme},
      url:
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_notification_scheme(String.t(), Jira.UpdateNotificationSchemeDetails.t(), keyword) ::
          {:ok, map} | {:error, Jira.ErrorCollection.t()}
  def update_notification_scheme(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Jira.IssueNotificationSchemes, :update_notification_scheme},
      url: "/rest/api/2/notificationscheme/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.UpdateNotificationSchemeDetails, :t}}],
      response: [
        {204, :map},
        {400, {Jira.ErrorCollection, :t}},
        {401, {Jira.ErrorCollection, :t}},
