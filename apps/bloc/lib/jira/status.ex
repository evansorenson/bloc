defmodule Jira.Status do
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec create_statuses(Jira.StatusCreateRequest.t(), keyword) ::
          {:ok, [Jira.JiraStatus.t()]} | {:error, any}
  def create_statuses(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Status, :create_statuses},
      url: "/rest/api/2/statuses",
      body: body,
      method: :post,
      request: [{"application/json", {Jira.StatusCreateRequest, :t}}],
      response: [{200, [{Jira.JiraStatus, :t}]}, {400, :unknown}, {401, :null}, {409, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  def delete_statuses_by_id(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Status, :delete_statuses_by_id},
      url: "/rest/api/2/statuses",
      method: :delete,
      query: query,
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_statuses_by_id(keyword) :: {:ok, [Jira.JiraStatus.t()]} | :error
  def get_statuses_by_id(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jira.Status, :get_statuses_by_id},
      url: "/rest/api/2/statuses",
      method: :get,
      query: query,
      response: [{200, [{Jira.JiraStatus, :t}]}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec search(keyword) :: {:ok, Jira.PageOfStatuses.t()} | :error
  def search(opts \\ []) do
    client = opts[:client] || @default_client
    ...
    client.request(%{
      args: [],
      call: {Jira.Status, :search},
      url: "/rest/api/2/statuses/search",
      method: :get,
      query: query,
      response: [{200, {Jira.PageOfStatuses, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer Jira* [project permission.](https://confluence.atlassian.com/x/yodKLg)
  """
  @spec update_statuses(Jira.StatusUpdateRequest.t(), keyword) :: {:ok, map} | {:error, any}
  def update_statuses(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jira.Status, :update_statuses},
      url: "/rest/api/2/statuses",
      body: body,
      method: :put,
      request: [{"application/json", {Jira.StatusUpdateRequest, :t}}],
