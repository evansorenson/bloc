defmodule Jira.IssueCommentProperties do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** either of:
  ...
  def delete_comment_property(commentId, propertyKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueCommentProperties, :delete_comment_property},
  ...
  **[Permissions](#permissions) required:**
  ...
  def get_comment_property(commentId, propertyKey, opts \\ []) do
    ...
    client.request(%{
      args: [commentId: commentId, propertyKey: propertyKey],
      call: {Jira.IssueCommentProperties, :get_comment_property},
      url: "/rest/api/2/comment/#{commentId}/properties/#{propertyKey}",
      method: :get,
      response: [
  ...
  **[Permissions](#permissions) required:**
   ...
   *  If the comment has visibility restrictions, belongs to the group or has the role visibility is restricted to.
  """
  @spec get_comment_property_keys(String.t(), keyword) :: {:ok, Jira.PropertyKeys.t()} | :error
  def get_comment_property_keys(commentId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [commentId: commentId],
      call: {Jira.IssueCommentProperties, :get_comment_property_keys},
  ...
  **[Permissions](#permissions) required:** either of:
  ...
  def set_comment_property(commentId, propertyKey, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jira.IssueCommentProperties, :set_comment_property},
      url: "/rest/api/2/comment/#{commentId}/properties/#{propertyKey}",
      body: body,
      method: :put,
