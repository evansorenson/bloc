defmodule Jirex.IssueSecuritySchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec add_security_level(String.t(), Jirex.AddSecuritySchemeLevelsRequestBean.t(), keyword) ::
  ...
  def add_security_level(schemeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :add_security_level},
      url: "/rest/api/2/issuesecurityschemes/#{schemeId}/level",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.AddSecuritySchemeLevelsRequestBean, :t}}],
      response: [
        {204, :map},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec add_security_level_members(
          String.t(),
          String.t(),
          Jirex.SecuritySchemeMembersRequest.t(),
          keyword
        ) :: {:ok, map} | {:error, Jirex.ErrorCollection.t()}
  def add_security_level_members(schemeId, levelId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :add_security_level_members},
      url: "/rest/api/2/issuesecurityschemes/#{schemeId}/level/#{levelId}/member",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.SecuritySchemeMembersRequest, :t}}],
      response: [
        {204, :map},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec associate_schemes_to_projects(
          Jirex.AssociateSecuritySchemeWithProjectDetails.t(),
          keyword
  ...
  def associate_schemes_to_projects(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.IssueSecuritySchemes, :associate_schemes_to_projects},
      url: "/rest/api/2/issuesecurityschemes/project",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.AssociateSecuritySchemeWithProjectDetails, :t}}],
      response: [
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_issue_security_scheme(Jirex.CreateIssueSecuritySchemeDetails.t(), keyword) ::
          {:ok, Jirex.SecuritySchemeId.t()} | {:error, Jirex.ErrorCollection.t()}
  def create_issue_security_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.IssueSecuritySchemes, :create_issue_security_scheme},
      url: "/rest/api/2/issuesecurityschemes",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.CreateIssueSecuritySchemeDetails, :t}}],
      response: [
        {201, {Jirex.SecuritySchemeId, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
        {403, {Jirex.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_security_scheme(schemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :delete_security_scheme},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec get_issue_security_scheme(integer, keyword) :: {:ok, Jirex.SecurityScheme.t()} | :error
  def get_issue_security_scheme(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Jirex.IssueSecuritySchemes, :get_issue_security_scheme},
      url: "/rest/api/2/issuesecurityschemes/#{id}",
      method: :get,
      response: [{200, {Jirex.SecurityScheme, :t}}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec get_issue_security_schemes(keyword) :: {:ok, Jirex.SecuritySchemes.t()} | :error
  def get_issue_security_schemes(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Jirex.IssueSecuritySchemes, :get_issue_security_schemes},
      url: "/rest/api/2/issuesecurityschemes",
      method: :get,
      response: [{200, {Jirex.SecuritySchemes, :t}}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_security_level_members(keyword) ::
          {:ok, Jirex.PageBeanSecurityLevelMember.t()} | {:error, any}
  def get_security_level_members(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueSecuritySchemes, :get_security_level_members},
      url: "/rest/api/2/issuesecurityschemes/level/member",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanSecurityLevelMember, :t}},
        {400, :null},
        {401, :null},
        {403, :unknown}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_security_levels(keyword) ::
          {:ok, Jirex.PageBeanSecurityLevel.t()} | {:error, Jirex.ErrorCollection.t()}
  def get_security_levels(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueSecuritySchemes, :get_security_levels},
      url: "/rest/api/2/issuesecurityschemes/level",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanSecurityLevel, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
        {403, {Jirex.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec remove_level(String.t(), String.t(), keyword) :: :ok | {:error, Jirex.ErrorCollection.t()}
  def remove_level(schemeId, levelId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :remove_level},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def remove_member_from_security_level(schemeId, levelId, memberId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :remove_member_from_security_level},
  ...
  @spec search_projects_using_security_schemes(keyword) ::
          {:ok, Jirex.PageBeanIssueSecuritySchemeToProjectMapping.t()}
  ...
  def search_projects_using_security_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueSecuritySchemes, :search_projects_using_security_schemes},
      url: "/rest/api/2/issuesecurityschemes/project",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanIssueSecuritySchemeToProjectMapping, :t}},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
        {403, {Jirex.ErrorCollection, :t}}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec search_security_schemes(keyword) ::
          {:ok, Jirex.PageBeanSecuritySchemeWithProjects.t()} | {:error, any}
  def search_security_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueSecuritySchemes, :search_security_schemes},
      url: "/rest/api/2/issuesecurityschemes/search",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanSecuritySchemeWithProjects, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec set_default_levels(Jirex.SetDefaultLevelsRequest.t(), keyword) ::
          {:ok, map} | {:error, Jirex.ErrorCollection.t()}
  def set_default_levels(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.IssueSecuritySchemes, :set_default_levels},
      url: "/rest/api/2/issuesecurityschemes/level/default",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.SetDefaultLevelsRequest, :t}}],
      response: [
        {204, :map},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec update_issue_security_scheme(
          String.t(),
          Jirex.UpdateIssueSecuritySchemeRequestBean.t(),
          keyword
        ) :: {:ok, map} | {:error, Jirex.ErrorCollection.t()}
  def update_issue_security_scheme(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueSecuritySchemes, :update_issue_security_scheme},
      url: "/rest/api/2/issuesecurityschemes/#{id}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.UpdateIssueSecuritySchemeRequestBean, :t}}],
      response: [
        {204, :map},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec update_security_level(
          String.t(),
          String.t(),
          Jirex.UpdateIssueSecurityLevelDetails.t(),
          keyword
        ) :: {:ok, map} | {:error, Jirex.ErrorCollection.t()}
  def update_security_level(schemeId, levelId, body, opts \\ []) do
    ...
    client.request(%{
      args: [schemeId: schemeId, levelId: levelId, body: body],
      call: {Jirex.IssueSecuritySchemes, :update_security_level},
      url: "/rest/api/2/issuesecurityschemes/#{schemeId}/level/#{levelId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.UpdateIssueSecurityLevelDetails, :t}}],
      response: [
        {204, :map},
        {400, {Jirex.ErrorCollection, :t}},
        {401, {Jirex.ErrorCollection, :t}},
