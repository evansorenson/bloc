defmodule Jirex.ServiceRegistry do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** Only Connect apps can make this request and the servicesIds belong to the tenant you are requesting
  ...
  def service_registry_resource_services_get(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.ServiceRegistry, :service_registry_resource_services_get},
      url: "/rest/atlassian-connect/1/service-registry",
      method: :get,
      query: query,
      response: [
        {200, [{Jirex.ServiceRegistry, :t}]},
        {400, :null},
        {401, :null},
        {403, :null},
        {500, :null},
  ...
  @type t :: %__MODULE__{
          ...
          serviceTier: Jirex.ServiceRegistryTier.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      serviceTier: {Jirex.ServiceRegistryTier, :t}
    ]
  end
end
