defmodule Jirex.JQLFunctionsApps do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** This API is only accessible to apps and apps can only inspect their own functions.
  ...
  @spec get_precomputations(keyword) ::
          {:ok, Jirex.PageBeanJqlFunctionPrecomputationBean.t()} | :error
  def get_precomputations(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.JQLFunctionsApps, :get_precomputations},
      url: "/rest/api/2/jql/function/computation",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanJqlFunctionPrecomputationBean, :t}},
        {400, :null},
        {401, :null},
        {403, :null},
        {404, :null}
  ...
  **[Permissions](#permissions) required:** An API for apps to update their own precomputations.
  """
  @spec update_precomputations(Jirex.JqlFunctionPrecomputationUpdateRequestBean.t(), keyword) ::
          {:ok, map} | :error
  def update_precomputations(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.JQLFunctionsApps, :update_precomputations},
      url: "/rest/api/2/jql/function/computation",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.JqlFunctionPrecomputationUpdateRequestBean, :t}}],
