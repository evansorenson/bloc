defmodule Jirex.ClassificationLevels do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** None.
  ...
  @spec get_all_user_data_classification_levels(keyword) ::
          {:ok, Jirex.DataClassificationLevelsBean.t()} | :error
  def get_all_user_data_classification_levels(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.ClassificationLevels, :get_all_user_data_classification_levels},
      url: "/rest/api/2/classification-levels",
      method: :get,
      query: query,
      response: [{200, {Jirex.DataClassificationLevelsBean, :t}}, {401, :null}],
      opts: opts
    })
  end
end
