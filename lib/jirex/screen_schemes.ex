defmodule Jirex.ScreenSchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_screen_scheme(Jirex.ScreenSchemeDetails.t(), keyword) ::
          {:ok, Jirex.ScreenSchemeId.t()} | {:error, any}
  def create_screen_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.ScreenSchemes, :create_screen_scheme},
      url: "/rest/api/2/screenscheme",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.ScreenSchemeDetails, :t}}],
      response: [
        {201, {Jirex.ScreenSchemeId, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown}
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_screen_scheme(screenSchemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ScreenSchemes, :delete_screen_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_screen_schemes(keyword) :: {:ok, Jirex.PageBeanScreenScheme.t()} | :error
  def get_screen_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.ScreenSchemes, :get_screen_schemes},
      url: "/rest/api/2/screenscheme",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBeanScreenScheme, :t}}, {401, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_screen_scheme(String.t(), Jirex.UpdateScreenSchemeDetails.t(), keyword) ::
          {:ok, map} | {:error, any}
  def update_screen_scheme(screenSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.ScreenSchemes, :update_screen_scheme},
      url: "/rest/api/2/screenscheme/#{screenSchemeId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.UpdateScreenSchemeDetails, :t}}],
