defmodule Jirex.IssueCustomFieldOptionsApps do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  """
  @spec create_issue_field_option(String.t(), Jirex.IssueFieldOptionCreateBean.t(), keyword) ::
          {:ok, Jirex.IssueFieldOption.t()} | :error
  def create_issue_field_option(fieldKey, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fieldKey: fieldKey, body: body],
      call: {Jirex.IssueCustomFieldOptionsApps, :create_issue_field_option},
      url: "/rest/api/2/field/#{fieldKey}/option",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.IssueFieldOptionCreateBean, :t}}],
      response: [{200, {Jirex.IssueFieldOption, :t}}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  ...
  def delete_issue_field_option(fieldKey, optionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptionsApps, :delete_issue_field_option},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  ...
  @spec get_all_issue_field_options(String.t(), keyword) ::
          {:ok, Jirex.PageBeanIssueFieldOption.t()} | :error
  def get_all_issue_field_options(fieldKey, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptionsApps, :get_all_issue_field_options},
      url: "/rest/api/2/field/#{fieldKey}/option",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBeanIssueFieldOption, :t}}, {400, :null}, {403, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  ...
  def get_issue_field_option(fieldKey, optionId, opts \\ []) do
    ...
    client.request(%{
      args: [fieldKey: fieldKey, optionId: optionId],
      call: {Jirex.IssueCustomFieldOptionsApps, :get_issue_field_option},
      url: "/rest/api/2/field/#{fieldKey}/option/#{optionId}",
      method: :get,
      response: [{200, {Jirex.IssueFieldOption, :t}}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_selectable_issue_field_options(fieldKey, opts \\ []) do
    ...
    client.request(%{
      args: [fieldKey: fieldKey],
      call: {Jirex.IssueCustomFieldOptionsApps, :get_selectable_issue_field_options},
      url: "/rest/api/2/field/#{fieldKey}/option/suggestions/edit",
      method: :get,
      query: query,
      response: [{200, {Jirex.PageBeanIssueFieldOption, :t}}, {401, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
  ...
  def get_visible_issue_field_options(fieldKey, opts \\ []) do
    ...
    client.request(%{
      args: [fieldKey: fieldKey],
      call: {Jirex.IssueCustomFieldOptionsApps, :get_visible_issue_field_options},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  ...
  """
  @spec replace_issue_field_option(String.t(), integer, keyword) :: :ok | {:error, any}
  def replace_issue_field_option(fieldKey, optionId, opts \\ []) do
    ...
    client.request(%{
      args: [fieldKey: fieldKey, optionId: optionId],
      call: {Jirex.IssueCustomFieldOptionsApps, :replace_issue_field_option},
      url: "/rest/api/2/field/#{fieldKey}/option/#{optionId}/issue",
      method: :delete,
      query: query,
      response: [
        {303, {Jirex.TaskProgressBeanRemoveOptionFromIssuesResult, :t}},
        {400, :null},
        {403, :unknown},
        {404, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). Jira permissions are not required for the app providing the field.
  """
  @spec update_issue_field_option(String.t(), integer, Jirex.IssueFieldOption.t(), keyword) ::
          {:ok, Jirex.IssueFieldOption.t()} | :error
  def update_issue_field_option(fieldKey, optionId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueCustomFieldOptionsApps, :update_issue_field_option},
      url: "/rest/api/2/field/#{fieldKey}/option/#{optionId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.IssueFieldOption, :t}}],
      response: [{200, {Jirex.IssueFieldOption, :t}}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
