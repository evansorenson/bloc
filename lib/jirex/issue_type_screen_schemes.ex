defmodule Jirex.IssueTypeScreenSchemes do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec append_mappings_for_issue_type_screen_scheme(
          String.t(),
          Jirex.IssueTypeScreenSchemeMappingDetails.t(),
          keyword
        ) :: {:ok, map} | {:error, any}
  def append_mappings_for_issue_type_screen_scheme(issueTypeScreenSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueTypeScreenSchemes, :append_mappings_for_issue_type_screen_scheme},
      url: "/rest/api/2/issuetypescreenscheme/#{issueTypeScreenSchemeId}/mapping",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.IssueTypeScreenSchemeMappingDetails, :t}}],
      response: [
        {204, :map},
        {400, :unknown},
        {401, :null},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec assign_issue_type_screen_scheme_to_project(
          Jirex.IssueTypeScreenSchemeProjectAssociation.t(),
          keyword
        ) :: {:ok, map} | {:error, any}
  def assign_issue_type_screen_scheme_to_project(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jirex.IssueTypeScreenSchemes, :assign_issue_type_screen_scheme_to_project},
      url: "/rest/api/2/issuetypescreenscheme/project",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.IssueTypeScreenSchemeProjectAssociation, :t}}],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_issue_type_screen_scheme(Jirex.IssueTypeScreenSchemeDetails.t(), keyword) ::
          {:ok, Jirex.IssueTypeScreenSchemeId.t()} | {:error, any}
  def create_issue_type_screen_scheme(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jirex.IssueTypeScreenSchemes, :create_issue_type_screen_scheme},
      url: "/rest/api/2/issuetypescreenscheme",
      body: body,
      method: :post,
      request: [{"application/json", {Jirex.IssueTypeScreenSchemeDetails, :t}}],
      response: [
        {201, {Jirex.IssueTypeScreenSchemeId, :t}},
        {400, :unknown},
        {401, :null},
        {403, :unknown},
        {404, :unknown},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  def delete_issue_type_screen_scheme(issueTypeScreenSchemeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Jirex.IssueTypeScreenSchemes, :delete_issue_type_screen_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_screen_scheme_mappings(keyword) ::
          {:ok, Jirex.PageBeanIssueTypeScreenSchemeItem.t()} | :error
  def get_issue_type_screen_scheme_mappings(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueTypeScreenSchemes, :get_issue_type_screen_scheme_mappings},
      url: "/rest/api/2/issuetypescreenscheme/mapping",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanIssueTypeScreenSchemeItem, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_screen_scheme_project_associations(keyword) ::
          {:ok, Jirex.PageBeanIssueTypeScreenSchemesProjects.t()} | :error
  def get_issue_type_screen_scheme_project_associations(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueTypeScreenSchemes, :get_issue_type_screen_scheme_project_associations},
      url: "/rest/api/2/issuetypescreenscheme/project",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanIssueTypeScreenSchemesProjects, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_issue_type_screen_schemes(keyword) ::
          {:ok, Jirex.PageBeanIssueTypeScreenScheme.t()} | :error
  def get_issue_type_screen_schemes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jirex.IssueTypeScreenSchemes, :get_issue_type_screen_schemes},
      url: "/rest/api/2/issuetypescreenscheme",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanIssueTypeScreenScheme, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_projects_for_issue_type_screen_scheme(integer, keyword) ::
          {:ok, Jirex.PageBeanProjectDetails.t()} | :error
  def get_projects_for_issue_type_screen_scheme(issueTypeScreenSchemeId, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeScreenSchemeId: issueTypeScreenSchemeId],
      call: {Jirex.IssueTypeScreenSchemes, :get_projects_for_issue_type_screen_scheme},
      url: "/rest/api/2/issuetypescreenscheme/#{issueTypeScreenSchemeId}/project",
      method: :get,
      query: query,
      response: [
        {200, {Jirex.PageBeanProjectDetails, :t}},
        {400, :null},
        {401, :null},
        {403, :null}
      ],
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec remove_mappings_from_issue_type_screen_scheme(String.t(), Jirex.IssueTypeIds.t(), keyword) ::
          {:ok, map} | {:error, any}
  def remove_mappings_from_issue_type_screen_scheme(issueTypeScreenSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeScreenSchemeId: issueTypeScreenSchemeId, body: body],
      call: {Jirex.IssueTypeScreenSchemes, :remove_mappings_from_issue_type_screen_scheme},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec update_default_screen_scheme(String.t(), Jirex.UpdateDefaultScreenScheme.t(), keyword) ::
          {:ok, map} | {:error, any}
  def update_default_screen_scheme(issueTypeScreenSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeScreenSchemeId: issueTypeScreenSchemeId, body: body],
      call: {Jirex.IssueTypeScreenSchemes, :update_default_screen_scheme},
      url: "/rest/api/2/issuetypescreenscheme/#{issueTypeScreenSchemeId}/mapping/default",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.UpdateDefaultScreenScheme, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec update_issue_type_screen_scheme(
          String.t(),
          Jirex.IssueTypeScreenSchemeUpdateDetails.t(),
          keyword
        ) :: {:ok, map} | {:error, any}
  def update_issue_type_screen_scheme(issueTypeScreenSchemeId, body, opts \\ []) do
    ...
    client.request(%{
      args: [issueTypeScreenSchemeId: issueTypeScreenSchemeId, body: body],
      call: {Jirex.IssueTypeScreenSchemes, :update_issue_type_screen_scheme},
      url: "/rest/api/2/issuetypescreenscheme/#{issueTypeScreenSchemeId}",
      body: body,
      method: :put,
      request: [{"application/json", {Jirex.IssueTypeScreenSchemeUpdateDetails, :t}}],
      response: [{204, :map}, {400, :unknown}, {401, :null}, {403, :unknown}, {404, :unknown}],
      opts: opts
    })
  end
